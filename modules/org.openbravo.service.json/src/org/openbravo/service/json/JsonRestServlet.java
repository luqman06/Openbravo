...
public class JsonRestServlet extends BaseWebServiceServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    SessionInfo.setSessionId(vars1.getSessionValue("#AD_Session_Track"));
    
  //set process id ant process type 
    SessionInfo.setProcessType("oez_API");
    SessionInfo.setProcessId("oez_API");
