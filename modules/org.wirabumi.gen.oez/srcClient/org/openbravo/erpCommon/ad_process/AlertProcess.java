                ...
                for (User targetUser : usersList) {
                  ...
                  try {
                    ...
                    con.setRequestProperty("Authorization",
                        "Basic OWVkZTM1MTQtN2UyMS00ZmI0LWJlOWYtMDAwM2RiNTg2MWM5");
                    con.setRequestMethod("POST");

                    String headingsAppsNotification = "Ok";

                    if (docNo.substring(0, 2) == "PR") {
                      headingsAppsNotification = "Purchase Requisition";
                    } else if (docNo.substring(0, 2) == "PO") {
                      headingsAppsNotification = "Purchase Order";
                    } else if (docNo.substring(0, 2) == "GM") {
                      headingsAppsNotification = "Goods Movement";
                    }

                    String strJsonBody = "{"
                        + "\"app_id\": \"f7103642-60f5-44da-8669-19c0878d7114\","
