...
class WindowTreeChecks {
  ...
  public static String checkSpecificChanges(ConnectionProvider conn, VariablesSecureApp vars,
    ...
    if (TreeType.equals("MM")) { // Menu
      ...
      result = "";
    } else if (TreeType.equals("Hris_C_Bp_Department_ID")) { // User Defined Dimension 1
        result = "";
    } else if (TreeType.equals("Hris_Jobtitle_ID")) { // User Defined Dimension 2
        result = "";
    } else if (TreeType.equals("Hris_Kpi_ID")) { // User Defined Dimension 2
        result = "";
    } else
