...
class WindowTreeUtility {
  ...
  public static String getTreeType(String keyColumnName) {
    ...
    if (keyColumnName.equals("AD_Menu_ID"))
      ...
      TreeType = "CH";
    else if (keyColumnName.equals("Hris_C_Bp_Department_ID"))
      TreeType = "HRIS_DP";
    else if (keyColumnName.equals("Hris_Jobtitle_ID"))
      TreeType = "HRIS_JT";
    else if (keyColumnName.equals("Hris_Kpi_ID"))
      TreeType = "HRIS_KPI";
    else
      TreeType = "";
    if (TreeType.equals(""))
  ...
  public static WindowTreeData[] getTree(ConnectionProvider conn, VariablesSecureApp vars,
    ...
    if (TreeType.equals("MM")) {
      ...
      data = WindowTreeData
          .selectBusinessPartner(conn, strEditable, strParentID, strNodeId, TreeID);
    else if (TreeType.equals("HRIS_DP"))
      data = WindowTreeData.selectDepartment(conn, strEditable, strParentID, strNodeId, TreeID);
    else if (TreeType.equals("HRIS_JT"))
      data = WindowTreeData.selectJobTitle(conn, strEditable, strParentID, strNodeId, TreeID);
    else if (TreeType.equals("HRIS_KPI"))
      data = WindowTreeData.selectKPI(conn, strEditable, strParentID, strNodeId, TreeID);
