...
public class DocRecordLeave extends DalBaseProcess {
  private static Logger log4j = Logger.getLogger(DocRecordLeave.class);
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      RecordLeave(connectionProvider);
  ...
  private void RecordLeave(Connection connectionProvider) {
    String strSql;
    ResultSet result;
    ...
    try {
      strSql = "SELECT result from lv_recordleave(null)";
