...
public class PurchaseRequestBean implements FieldProvider{
	...
	public String getField(String fieldName) {
		...
		case "noline": return this.noline;
	...
	public static class Builder{
		...
		public Builder(String documentNo, String department, String requester, String daterequested,
				String lineDescription, String uom, String quantity, String product_name) {
		...
		public Builder noline(String noline) {
			this.noline=noline; return this;
