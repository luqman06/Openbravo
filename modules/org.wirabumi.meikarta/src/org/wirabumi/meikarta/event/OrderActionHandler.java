	...
	public void doRouting(String adWindowId, String adTabId,
		...
		for (String orderID : recordId){
			...
			if (doc_status_to.equalsIgnoreCase(completeStatus)){
				...
				continue; //bukan complete, bukan reactive, bukan close
...
//					message = message.substring(8, message.length()-1);
			...
			//jika docstatus adalah reactive, maka send email ke creator nya.
			if (doc_status_to.equalsIgnoreCase(reactiveStatus))
				EmailUtility.sendEmailReactivateOrder(order);
