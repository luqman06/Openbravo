...
public class DocAkumulasiPGaji extends DalBaseProcess {
  private static Logger log4j = Logger.getLogger(DocAkumulasiPGaji.class);
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      AkumulasiPotongGaji(connectionProvider);
  ...
  private void AkumulasiPotongGaji(Connection connectionProvider) {
    String strSql;
    ResultSet result;
    ...
    try {
      strSql = "SELECT result FROM ta_kalkulasi_potong_gaji(null, null)";
