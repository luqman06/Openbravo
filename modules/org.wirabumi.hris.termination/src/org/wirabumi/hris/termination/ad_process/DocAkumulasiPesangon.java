...
public class DocAkumulasiPesangon extends DalBaseProcess {
  private static Logger log4j = Logger.getLogger(DocAkumulasiPesangon.class);
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      AkumulasiPesangon(connectionProvider);
  ...
  private void AkumulasiPesangon(Connection connectionProvider) {
    String strSql;
    ResultSet result;
    ...
    try {
      strSql = "select result from tm_akumulasi_pesangon(null)";
