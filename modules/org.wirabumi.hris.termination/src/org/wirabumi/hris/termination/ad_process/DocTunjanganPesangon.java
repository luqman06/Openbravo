...
public class DocTunjanganPesangon extends DalBaseProcess {
  private static Logger log4j = Logger.getLogger(DocTunjanganPesangon.class);
  ...
  public void doExecute(ProcessBundle bundle) throws Exception {
    ...
    try {
      ...
      TunjanganPesangon(connectionProvider);
  ...
  private void TunjanganPesangon(Connection connectionProvider) {
    String strSql;
    ResultSet result;
    ...
    try {
      strSql = "select result from tm_tunjangan_pesangon(null, null)";
