...
class AcctServerData implements FieldProvider {
  ...
  public String getField(String fieldName) {
    if (fieldName.equalsIgnoreCase("id"))
      ...
      return cDoctypeId;
    else if (fieldName.equalsIgnoreCase("c_doctypetarget_id")
        || fieldName.equals("cDoctypetargetId"))
      ...
      return cBpartnerId;
    else if (fieldName.equalsIgnoreCase("c_bpartner_location_id")
        || fieldName.equals("cBpartnerLocationId"))
  ...
  public static AcctServerData[] select(ConnectionProvider connectionProvider, String tableName,
      String client, String org, String dateColumn) throws ServletException {
    return select(connectionProvider, tableName, client, org, dateColumn, 0, 0);
  }

  public static AcctServerData[] select(ConnectionProvider connectionProvider, String tableName,
      String client, String org, String dateColumn, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql + "       Select * from(" + "        SELECT  a.";
    ...
    strSql = strSql
        ...
        + "        FROM ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + " a, ad_org WHERE a.AD_CLIENT_ID=?"
        + "        AND ad_org.ad_org_id=a.ad_org_id"
        + "        AND AD_ISORGINCLUDED(ad_org.ad_org_id, ?, ad_org.ad_client_id)<>-1"
        + "        AND PROCESSED='Y'" + "        AND (PROCESSING='N' OR PROCESSING IS NULL)"
        + "        AND POSTED='N'" + "        ORDER BY a.";
    ...
    try {
      ...
      while (continueResult && result.next()) {
        ...
        objectAcctServerData.cBpartnerLocationId = UtilSql.getValue(result,
  ...
  public static int update(ConnectionProvider connectionProvider, String tableName, String id)
      throws ServletException {
    String strSql = "";
    strSql = strSql + "        UPDATE ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + " SET Processing='Y'" + "        WHERE ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + "_ID = ?" + "        AND Processed='Y'"
  ...
  public static AcctServerData[] selectDocType(ConnectionProvider connectionProvider, String docType)
      throws ServletException {
    return selectDocType(connectionProvider, docType, 0, 0);
  }

  public static AcctServerData[] selectDocType(ConnectionProvider connectionProvider,
      String docType, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, docType);
  ...
  public static AcctServerData[] selectGLCategory(ConnectionProvider connectionProvider,
      String client, String DocBaseType) throws ServletException {
    return selectGLCategory(connectionProvider, client, DocBaseType, 0, 0);
  }

  public static AcctServerData[] selectGLCategory(ConnectionProvider connectionProvider,
      String client, String DocBaseType, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      ...
      UtilSql.setValue(st, iParameter, 12, null, client);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, DocBaseType);
  ...
  public static AcctServerData[] selectDefaultGLCategory(ConnectionProvider connectionProvider,
      String client) throws ServletException {
    return selectDefaultGLCategory(connectionProvider, client, 0, 0);
  }

  public static AcctServerData[] selectDefaultGLCategory(ConnectionProvider connectionProvider,
      String client, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "        SELECT GL_Category_ID FROM GL_Category"
  ...
  public static int delete(ConnectionProvider connectionProvider, String Table, String Record)
      throws ServletException {
    String strSql = "";
    strSql = strSql + "        DELETE FROM Fact_Acct WHERE AD_Table_ID = ? AND Record_ID = ?";
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, Table);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, Record);
  ...
  public static AcctServerData[] currencyConvert(ConnectionProvider connectionProvider, String Amt,
      String CurFrom_ID, String CurTo_ID, String Date, String RateType, String client, String org)
      throws ServletException {
    return currencyConvert(connectionProvider, Amt, CurFrom_ID, CurTo_ID, Date, RateType, client,
        org, 0, 0);
  }
  ...
  public static AcctServerData[] currencyConvert(ConnectionProvider connectionProvider, String Amt,
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, Amt);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, CurFrom_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, CurTo_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, Date);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, RateType);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, client);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, org);
  ...
  public static AcctServerData[] currencyConvertionRate(ConnectionProvider connectionProvider,
      String CurFrom_ID, String CurTo_ID, String Date, String RateType, String client, String org)
      throws ServletException {
    return currencyConvertionRate(connectionProvider, CurFrom_ID, CurTo_ID, Date, RateType, client,
        org, 0, 0);
  }
  ...
  public static AcctServerData[] periodOpen(ConnectionProvider connectionProvider,
      String AD_Client_ID, String DocumentType, String Org, String DateAcct)
      throws ServletException {
    return periodOpen(connectionProvider, AD_Client_ID, DocumentType, Org, DateAcct, 0, 0);
  }

  public static AcctServerData[] periodOpen(ConnectionProvider connectionProvider,
      String AD_Client_ID, String DocumentType, String Org, String DateAcct, int firstRegister,
      int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "      select max(c_period.c_period_id) as period"
        + "      from c_period, c_periodcontrol"
        + "      where c_period.c_period_id = c_periodcontrol.c_period_id"
        + "      and c_period.ad_client_id = ?" + "      and c_periodcontrol.docbasetype = ?"
    ...
    try {
      ...
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, DocumentType);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, Org);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, DateAcct);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, DateAcct);
  ...
  public static int updateUnlock(ConnectionProvider connectionProvider, String tableName,
      String Record_ID) throws ServletException {
    String strSql = "";
    strSql = strSql + "        UPDATE ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + " SET Processing='N'" + "        WHERE ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + "_ID = ?";
    ...
    try {
      ...
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, Record_ID);
  ...
  public static int updateSave(ConnectionProvider connectionProvider, String tableName,
      String status, String adUserID, String Record_ID) throws ServletException {
    String strSql = "";
    strSql = strSql + "        UPDATE ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + " SET Posted= ? ,Processing='N', updated=now(), updatedby=?"
        + "        WHERE ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + "_ID = ?";
  ...
  public static AcctServerData[] selectMatch(ConnectionProvider connectionProvider,
      String AD_Client_ID) throws ServletException {
    return selectMatch(connectionProvider, AD_Client_ID, 0, 0);
  }

  public static AcctServerData[] selectMatch(ConnectionProvider connectionProvider,
      String AD_Client_ID, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql
  ...
  public static int insertMatchInv(Connection conn, ConnectionProvider connectionProvider,
      String M_MatchInv_ID, String AD_Client_ID, String AD_Org_ID, String M_InOutLine_ID,
    ...
    try {
      ...
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, M_MatchInv_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, AD_Client_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, AD_Org_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, M_InOutLine_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_InvoiceLine_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, M_Product_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, DateTrx);
      iParameter++;
  ...
  public static AcctServerData[] selectExpenseAcct(ConnectionProvider connectionProvider,
      String C_Charge_ID, String C_AcctSchema_ID) throws ServletException {
    return selectExpenseAcct(connectionProvider, C_Charge_ID, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectExpenseAcct(ConnectionProvider connectionProvider,
      String C_Charge_ID, String C_AcctSchema_ID, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_Charge_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_AcctSchema_ID);
  ...
  public static AcctServerData[] selectRevenueAcct(ConnectionProvider connectionProvider,
      String C_Charge_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectLiabilityAcct(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID) throws ServletException {
    return selectLiabilityAcct(connectionProvider, C_BPartner_ID, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectLiabilityAcct(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_BPartner_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_AcctSchema_ID);
  ...
  public static AcctServerData[] selectLiabilityServicesAcct(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectReceivableAcct(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectUnallocatedCashAcct(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
    return selectUnallocatedCashAcct(connectionProvider, C_BankAccount_ID, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectUnallocatedCashAcct(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_BankAccount_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_AcctSchema_ID);
  ...
  public static AcctServerData[] selectInTransitAcct(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectInTransitDefaultAcct(ConnectionProvider connectionProvider,
      String C_AcctSchema_ID) throws ServletException {
    return selectInTransitDefaultAcct(connectionProvider, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectInTransitDefaultAcct(ConnectionProvider connectionProvider,
      String C_AcctSchema_ID, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + " SELECT B_INTRANSIT_ACCT AS ACCOUNT_ID FROM C_Acctschema_Default"
  ...
  public static AcctServerData[] selectConvertChargeDefaultAmtAcct(
      ConnectionProvider connectionProvider, String C_AcctSchema_ID) throws ServletException {
    return selectConvertChargeDefaultAmtAcct(connectionProvider, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectConvertChargeDefaultAmtAcct(
      ConnectionProvider connectionProvider, String C_AcctSchema_ID, int firstRegister,
      int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + " SELECT B_Revaluationloss_Acct AS ACCOUNT_ID FROM C_ACCTSCHEMA_DEFAULT"
        + " WHERE C_ACCTSCHEMA_ID = ?";
  ...
  public static AcctServerData[] selectConvertGainDefaultAmtAcct(
      ConnectionProvider connectionProvider, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectConvertGainDefaultAmtAcct(
      ...
      int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + " SELECT B_Revaluationgain_Acct AS ACCOUNT_ID FROM C_ACCTSCHEMA_DEFAULT"
        + " WHERE C_ACCTSCHEMA_ID = ?";
  ...
  public static AcctServerData[] selectPaymentSelectAcct(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectWriteOffDefault(ConnectionProvider connectionProvider,
      String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectWriteOffDefault(ConnectionProvider connectionProvider,
      String C_AcctSchema_ID, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "        SELECT WRITEOFF_ACCT AS ACCOUNT_ID FROM C_ACCTSCHEMA_DEFAULT"
        + "        WHERE C_ACCTSCHEMA_ID = ?";
  ...
  public static AcctServerData[] selectWriteOffDefaultRevenue(
      ConnectionProvider connectionProvider, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectWriteOffDefaultRevenue(
      ...
      int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "        SELECT WRITEOFF_REV_ACCT AS ACCOUNT_ID FROM C_ACCTSCHEMA_DEFAULT"
        + "        WHERE C_ACCTSCHEMA_ID = ?";
  ...
  public static AcctServerData[] selectDiscountExpAcct(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectDiscountRevAcct(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectWriteOffAcct(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectWriteOffAcctRevenue(ConnectionProvider connectionProvider,
      String C_BPartner_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectAssetAcct(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectConvertChargeLossAmt(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectConvertChargeGainAmt(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectInterestRevAcct(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectInterestExpAcct(ConnectionProvider connectionProvider,
      String C_BankAccount_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectCBAssetAcct(ConnectionProvider connectionProvider,
      String C_CashBook_ID, String C_AcctSchema_ID) throws ServletException {
    return selectCBAssetAcct(connectionProvider, C_CashBook_ID, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectCBAssetAcct(ConnectionProvider connectionProvider,
      String C_CashBook_ID, String C_AcctSchema_ID, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_CashBook_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_AcctSchema_ID);
  ...
  public static AcctServerData[] selectCashTransferAcct(ConnectionProvider connectionProvider,
      String C_CashBook_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectCBExpenseAcct(ConnectionProvider connectionProvider,
      String C_CashBook_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectCBReceiptAcct(ConnectionProvider connectionProvider,
      String C_CashBook_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectCBDifferencesAcct(ConnectionProvider connectionProvider,
      String C_CashBook_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectWDifferencesAcct(ConnectionProvider connectionProvider,
      String M_Warehouse_ID, String C_AcctSchema_ID) throws ServletException {
    return selectWDifferencesAcct(connectionProvider, M_Warehouse_ID, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectWDifferencesAcct(ConnectionProvider connectionProvider,
      String M_Warehouse_ID, String C_AcctSchema_ID, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, M_Warehouse_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_AcctSchema_ID);
  ...
  public static AcctServerData[] selectNotInvoicedReceiptsAcct(
      ConnectionProvider connectionProvider, String C_BPartner_ID, String C_AcctSchema_ID)
      throws ServletException {
  ...
  public static AcctServerData[] selectPJAssetAcct(ConnectionProvider connectionProvider,
      String C_Project_ID, String C_AcctSchema_ID) throws ServletException {
    return selectPJAssetAcct(connectionProvider, C_Project_ID, C_AcctSchema_ID, 0, 0);
  }

  public static AcctServerData[] selectPJAssetAcct(ConnectionProvider connectionProvider,
      String C_Project_ID, String C_AcctSchema_ID, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
    ...
    try {
      st = connectionProvider.getPreparedStatement(strSql);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_Project_ID);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, C_AcctSchema_ID);
  ...
  public static AcctServerData[] selectPJWIPAcct(ConnectionProvider connectionProvider,
      String C_Project_ID, String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectPPVOffsetAcct(ConnectionProvider connectionProvider,
      String C_AcctSchema_ID) throws ServletException {
  ...
  public static AcctServerData[] selectTables(ConnectionProvider connectionProvider,
      String language, String adUserClient) throws ServletException {
    return selectTables(connectionProvider, language, adUserClient, 0, 0);
  }

  public static AcctServerData[] selectTables(ConnectionProvider connectionProvider,
      String language, String adUserClient, int firstRegister, int numberRegisters)
      throws ServletException {
    String strSql = "";
    strSql = strSql
        ...
        + "         AND AD_TABLE.ISACTIVE = 'Y'" + "         AND C_ACCTSCHEMA_TABLE.ISACTIVE = 'Y'"
  ...
  public static AcctServerData[] selectOrganizations(ConnectionProvider connectionProvider,
  ...
  public static AcctServerData selectDocuments(ConnectionProvider connectionProvider,
      String tableName, String adClientId, String adOrgId, String docbasetype, String dateColumn)
      throws ServletException {
    String strSql = "";
    strSql = strSql + "        select MIN(";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + "_ID) as id" + "        from ";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + " a, ad_org" + "        where posted = 'N'" + "        and processed = 'Y'"
        + "        and (processing = 'N' or processing is null)"
        + "        AND ad_org.ad_org_id=a.ad_org_id" + "        AND a.ad_client_id = ?"
        + "        AND AD_ISORGINCLUDED(ad_org.ad_org_id, ?, ad_org.ad_client_id)<>-1"
        + "        AND EXISTS (select 1"
        ...
        + "              and c_periodcontrol.periodstatus = 'O'" + "              and    a.";
    strSql = strSql + ((dateColumn == null || dateColumn.equals("")) ? "" : dateColumn);
    strSql = strSql + " >= c_period.StartDate" + "              and     a.";
    strSql = strSql + ((dateColumn == null || dateColumn.equals("")) ? "" : dateColumn);
    strSql = strSql + " < c_period.EndDate + 1)";
  ...
  public static AcctServerData filterDatesSelectDocuments(ConnectionProvider connectionProvider,
      String tableName, String adClientId, String adOrgId, String docbasetype, String dateColumn,
      String dateFrom, String dateTo) throws ServletException {
    String strSql = "";
    strSql = strSql + "        select MIN(";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + "_ID) as id" + "        from ";
    ...
    strSql = strSql + " >= c_period.StartDate" + "              and     a.";
    strSql = strSql + ((dateColumn == null || dateColumn.equals("")) ? "" : dateColumn);
    strSql = strSql + " < c_period.EndDate + 1)" + "        and      a.";
    strSql = strSql + ((dateColumn == null || dateColumn.equals("")) ? "" : dateColumn);
    strSql = strSql + " >= to_date(?)" + "        and       a.";
    strSql = strSql + ((dateColumn == null || dateColumn.equals("")) ? "" : dateColumn);
  ...
  public static AcctServerData[] selectDocTypes(ConnectionProvider connectionProvider,
      String table, String client) throws ServletException {
    return selectDocTypes(connectionProvider, table, client, 0, 0);
  }

  public static AcctServerData[] selectDocTypes(ConnectionProvider connectionProvider,
      String table, String client, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "      select docbasetype as name from c_doctype"
        + "      where ad_table_id = ?" + "      and ad_client_id = ?";
  ...
  public static String selectGroupLines(ConnectionProvider connectionProvider, String client)
      throws ServletException {
    String strSql = "";
    strSql = strSql + "        SELECT GROUPACCTINVLINES FROM AD_CLIENTINFO WHERE AD_CLIENT_ID = ?";
  ...
  public static String selectDescription(ConnectionProvider connectionProvider, String tableId,
      String acctschemaId) throws ServletException {
    String strSql = "";
    strSql = strSql + "        SELECT ACCTDESCRIPTION FROM C_ACCTSCHEMA_TABLE"
        + "        WHERE AD_TABLE_ID = ?" + "        AND C_ACCTSCHEMA_ID = ?";
  ...
  public static String selectBpartnerName(ConnectionProvider connectionProvider, String bpartnerId)
      throws ServletException {
    String strSql = "";
  ...
  public static String selectOrgName(ConnectionProvider connectionProvider, String org)
      throws ServletException {
    String strSql = "";
  ...
  public static String selectNegate(ConnectionProvider connectionProvider, String cAcctschemaId,
      String docbasetype) throws ServletException {
    String strSql = "";
    strSql = strSql
  ...
  public static String selectDefaultNegate(ConnectionProvider connectionProvider,
      String cAcctschemaId) throws ServletException {
    String strSql = "";
    strSql = strSql + "         SELECT ALLOWNEGATIVE" + "         FROM C_ACCTSCHEMA"
        + "         WHERE C_ACCTSCHEMA_ID = ?";
  ...
  public static String selectTemplate(ConnectionProvider connectionProvider, String cAcctschemaId,
      String adTableId) throws ServletException {
    String strSql = "";
    strSql = strSql
        + "        SELECT CLASSNAME"
        ...
        + "        AND C_ACCTSCHEMA_ID = ?" + "        AND C_ACCTSCHEMA_TABLE.AD_TABLE_ID = ?";
    ...
    try {
      ...
      UtilSql.setValue(st, iParameter, 12, null, cAcctschemaId);
      iParameter++;
      UtilSql.setValue(st, iParameter, 12, null, adTableId);
  ...
  public static String selectTemplateDoc(ConnectionProvider connectionProvider,
      String cAcctschemaId, String docbasetype) throws ServletException {
    String strSql = "";
    strSql = strSql
  ...
  public static AcctServerData[] selectAcctProcess(ConnectionProvider connectionProvider,
      String cAcctschemaId) throws ServletException {
    return selectAcctProcess(connectionProvider, cAcctschemaId, 0, 0);
  }

  public static AcctServerData[] selectAcctProcess(ConnectionProvider connectionProvider,
      String cAcctschemaId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "      SELECT AD_ACCTPROCESS.CLASSNAME"
        + "      FROM C_ACCTSCHEMA_PROCESS, AD_ACCTPROCESS"
        + "      WHERE C_ACCTSCHEMA_PROCESS.AD_ACCTPROCESS_ID = AD_ACCTPROCESS.AD_ACCTPROCESS_ID"
        + "      AND C_ACCTSCHEMA_PROCESS.C_ACCTSCHEMA_ID = ?" + "      ORDER BY SEQNO";
  ...
  public static AcctServerData[] getTableInfo(ConnectionProvider connectionProvider,
      String adTableId) throws ServletException {
    return getTableInfo(connectionProvider, adTableId, 0, 0);
  }

  public static AcctServerData[] getTableInfo(ConnectionProvider connectionProvider,
      String adTableId, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "      SELECT COLUMNNAME AS ACCTDATECOLUMN, TABLENAME, ACCTCLASSNAME"
  ...
  public static boolean selectBackgroundEnabled(ConnectionProvider connectionProvider,
      String acctschemaId, String tableId) throws ServletException {
    String strSql = "";
    strSql = strSql + "       SELECT COUNT(*) AS NAME FROM C_ACCTSCHEMA_TABLE"
        + "       WHERE C_ACCTSCHEMA_ID = ?" + "       AND AD_TABLE_ID = ?"
        + "       AND ISACTIVE = 'Y'" + "       AND ISBACKGROUNDDISABLED = 'N'";
  ...
  public static AcctServerData[] selectFilterDates(ConnectionProvider connectionProvider,
      String tableName, String client, String org, String dateColumn, String dateFrom, String dateTo)
      throws ServletException {
    return selectFilterDates(connectionProvider, tableName, client, org, dateColumn, dateFrom,
        dateTo, 0, 0);
  }

  public static AcctServerData[] selectFilterDates(ConnectionProvider connectionProvider,
      String tableName, String client, String org, String dateColumn, String dateFrom,
      String dateTo, int firstRegister, int numberRegisters) throws ServletException {
    String strSql = "";
    strSql = strSql + "          Select * from(" + "        SELECT  a.";
    strSql = strSql + ((tableName == null || tableName.equals("")) ? "" : tableName);
    strSql = strSql + "_ID AS ID" + "        FROM ";
    ...
    strSql = strSql + " >= to_date(?)" + "        AND  a.";
    strSql = strSql + ((dateColumn == null || dateColumn.equals("")) ? "" : dateColumn);
    strSql = strSql + " <= to_date(?)" + "        ORDER BY a.";
    strSql = strSql + ((dateColumn == null || dateColumn.equals("")) ? "" : dateColumn);
    strSql = strSql + ") A";
