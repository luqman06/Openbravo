...
static Logger log4j = Logger.getLogger(WindowTreeData.class);
  ...
  public static WindowTreeData[] selectBusinessPartner(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId)    throws ServletException {
    return selectBusinessPartner(connectionProvider, editable, parentId, nodeId, adTreeId, 0, 0);
  }

  public static WindowTreeData[] selectBusinessPartner(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT tn.Node_ID,tn.Parent_ID,tn.SeqNo, tr.C_Bpartner_ID AS ID, tr.NAME,tr.Description,tr.IsSummary " +
      "        FROM AD_TREENODE tn, C_Bpartner tr" +
      "        WHERE ";
    strSql = strSql + ((editable.equals("editable"))?" tn.IsActive='Y' AND tr.isActive='Y' AND  ":"");
    strSql = strSql + ((parentId==null || parentId.equals(""))?"":" tn.Parent_ID = ? AND  ");
    strSql = strSql + ((nodeId==null || nodeId.equals(""))?"":" tn.Node_ID = ? AND  ");
    strSql = strSql + 
      "tn.Node_ID = tr.C_Bpartner_ID" +
      "        AND tn.AD_Tree_ID = ?" +
      "        ORDER BY COALESCE(tn.Parent_ID, '-1'), tn.SeqNo";
  ...
  public static WindowTreeData[] selectDepartment(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId)    throws ServletException {
    return selectDepartment(connectionProvider, editable, parentId, nodeId, adTreeId, 0, 0);
  }

  public static WindowTreeData[] selectDepartment(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT tn.Node_ID,tn.Parent_ID,tn.SeqNo, tr.hris_c_bp_department_ID AS ID, tr.NAME,tr.Description,tr.IsSummary " +
      "        FROM AD_TREENODE tn, hris_c_bp_department tr" +
      "        WHERE ";
    strSql = strSql + ((editable.equals("editable"))?" tn.IsActive='Y' AND tr.isActive='Y' AND  ":"");
    strSql = strSql + ((parentId==null || parentId.equals(""))?"":" tn.Parent_ID = ? AND  ");
    strSql = strSql + ((nodeId==null || nodeId.equals(""))?"":" tn.Node_ID = ? AND  ");
    strSql = strSql + 
      "tn.Node_ID = tr.hris_c_bp_department_ID" +
      "        AND tn.AD_Tree_ID = ?" +
      "        ORDER BY COALESCE(tn.Parent_ID, '-1'), tn.SeqNo";
  ...
  public static WindowTreeData[] selectJobTitle(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId)    throws ServletException {
    return selectJobTitle(connectionProvider, editable, parentId, nodeId, adTreeId, 0, 0);
  }

  public static WindowTreeData[] selectJobTitle(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT tn.Node_ID,tn.Parent_ID,tn.SeqNo, tr.hris_jobtitle_ID AS ID, tr.NAME,tr.Description,tr.IsSummary " +
      "        FROM AD_TREENODE tn, hris_jobtitle tr" +
      "        WHERE ";
    strSql = strSql + ((editable.equals("editable"))?" tn.IsActive='Y' AND tr.isActive='Y' AND  ":"");
    strSql = strSql + ((parentId==null || parentId.equals(""))?"":" tn.Parent_ID = ? AND  ");
    strSql = strSql + ((nodeId==null || nodeId.equals(""))?"":" tn.Node_ID = ? AND  ");
    strSql = strSql + 
      "tn.Node_ID = tr.hris_jobtitle_ID" +
      "        AND tn.AD_Tree_ID = ?" +
      "        ORDER BY COALESCE(tn.Parent_ID, '-1'), tn.SeqNo";
  ...
  public static WindowTreeData[] selectKPI(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId)    throws ServletException {
    return selectKPI(connectionProvider, editable, parentId, nodeId, adTreeId, 0, 0);
  }

  public static WindowTreeData[] selectKPI(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT tn.Node_ID,tn.Parent_ID,tn.SeqNo, tr.hris_kpi_ID AS ID, tr.NAME,tr.Description,tr.IsSummary " +
      "        FROM AD_TREENODE tn, hris_kpi tr" +
      "        WHERE ";
    strSql = strSql + ((editable.equals("editable"))?" tn.IsActive='Y' AND tr.isActive='Y' AND  ":"");
    strSql = strSql + ((parentId==null || parentId.equals(""))?"":" tn.Parent_ID = ? AND  ");
    strSql = strSql + ((nodeId==null || nodeId.equals(""))?"":" tn.Node_ID = ? AND  ");
    strSql = strSql + 
      "tn.Node_ID = tr.hris_kpi_ID" +
      "        AND tn.AD_Tree_ID = ?" +
      "        ORDER BY COALESCE(tn.Parent_ID, '-1'), tn.SeqNo";
  ...
  public static WindowTreeData[] selectChValue(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId, String mCharacteristicId)    throws ServletException {
    return selectChValue(connectionProvider, editable, parentId, nodeId, adTreeId, mCharacteristicId, 0, 0);
  }

  public static WindowTreeData[] selectChValue(ConnectionProvider connectionProvider, String editable, String parentId, String nodeId, String adTreeId, String mCharacteristicId, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, adTreeId);
      iParameter++; UtilSql.setValue(st, iParameter, 12, null, mCharacteristicId);
