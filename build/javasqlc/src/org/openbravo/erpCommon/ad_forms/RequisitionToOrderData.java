...
static Logger log4j = Logger.getLogger(RequisitionToOrderData.class);
  ...
  public static RequisitionToOrderData[] select(ConnectionProvider connectionProvider, int firstRegister, int numberRegisters)    throws ServletException {
    String strSql = "";
    strSql = strSql + 
      "        SELECT '' AS DOCUMENTNO, '' AS M_REQUISITIONLINE_ID, '' AS REQQTY, '' AS MATCHEDQTY, '' AS QTYTOORDER, " +
      "          '' AS M_PRICELIST_ID, '' AS NEEDBYDATE, '' AS PRICELIST, '' AS PRICE, '' AS LINEDESCRIPTION," +
      "          '' AS M_PRODUCT_ID, '' AS M_ATTRIBUTESETINSTANCE_ID, '' AS VENDOR_ID, '' AS VENDOR, " +
      "          '' AS SearchKey, '' AS PRODUCT, '' AS ATTRIBUTE, ''  AS REQUESTER, '' AS PRICELISTID, '' AS VENDORPRICELIST," +
    ...
    st = connectionProvider.getPreparedStatement(strSql);
      ...
      while(continueResult && result.next()) {
        ...
        objectRequisitionToOrderData.linedescription = UtilSql.getValue(result, "linedescription");
        ...
        objectRequisitionToOrderData.searchkey = UtilSql.getValue(result, "searchkey");
  ...
  public static RequisitionToOrderData[] set()    throws ServletException {
    ...
    objectRequisitionToOrderData[0].linedescription = "";
    ...
    objectRequisitionToOrderData[0].searchkey = "";
  ...
  public static RequisitionToOrderData[] selectLines(ConnectionProvider connectionProvider, String language, String adUserClient, String adOrgId, String parDateFrom, String parDateTo, String parProduct, String parRequester, String parVendorInc, String parVendor, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "		  M_REQUISITIONLINE.DESCRIPTION AS LINEDESCRIPTION," +
      "          C_AUM," +
      "          C_UOM.C_UOM_ID," +
    ...
    strSql = strSql + 
      "        GROUP BY M_REQUISITION.DOCUMENTNO, M_REQUISITIONLINE.DESCRIPTION, M_REQUISITIONLINE.M_REQUISITIONLINE_ID, M_REQUISITIONLINE.NEEDBYDATE, M_REQUISITIONLINE.QTY, M_REQUISITIONLINE.ORDEREDQTY," +
      ...
      "        M_REQUISITIONLINE.M_PRODUCT_ID, M_PRODUCT.VALUE, M_REQUISITIONLINE.M_ATTRIBUTESETINSTANCE_ID, M_REQUISITION.AD_USER_ID" +
  ...
  public static RequisitionToOrderData[] selectSelected(ConnectionProvider connectionProvider, String language, String adUserId, String adUserClient, String adOrgId, int firstRegister, int numberRegisters)    throws ServletException {
    ...
    strSql = strSql + 
      ...
      "          QUANTITYORDER, M_REQUISITION.DOCUMENTNO," +
    ...
    strSql = strSql + 
      ")" +
      "        GROUP BY M_REQUISITION.DOCUMENTNO, M_REQUISITIONLINE.M_REQUISITIONLINE_ID, M_REQUISITIONLINE.NEEDBYDATE, M_REQUISITIONLINE.QTY," +
