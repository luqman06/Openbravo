 ...
 ************************************************************************
*/
package org.infinite.expensebudget;
...
/**
 * Entity class for entity eb_unrealizedusage (stored in table eb_unrealizedusage).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class UnrealizedBudgetUsage extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "eb_unrealizedusage";
    public static final String ENTITY_NAME = "eb_unrealizedusage";
    ...
    public BudgetLine getBudgetLine() {
        return (BudgetLine) get(PROPERTY_BUDGETLINE);
    }
