...
public class InternalConsumption extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZDOCTYPE = "oezDoctype";
    public static final String PROPERTY_SALESCAMPAIGN = "salesCampaign";
    public static final String PROPERTY_ACTIVITY = "activity";
    public static final String PROPERTY_OEZDOCUMENTNO = "oezDocumentno";
    public static final String PROPERTY_STDIMENSION = "stDimension";
    public static final String PROPERTY_NDDIMENSION = "ndDimension";
    public static final String PROPERTY_COSTCENTER = "costCenter";
    public static final String PROPERTY_CAMISASSETPARTCONSUMPTION = "camIsassetpartconsumption";
    ...
    public InternalConsumption() {
        ...
        setDefaultValue(PROPERTY_CAMISASSETPARTCONSUMPTION, false);
    ...
    public DocumentType getOezDoctype() {
        return (DocumentType) get(PROPERTY_OEZDOCTYPE);
    }

    public void setOezDoctype(DocumentType oezDoctype) {
        set(PROPERTY_OEZDOCTYPE, oezDoctype);
    }
    ...
    public String getOezDocumentno() {
        return (String) get(PROPERTY_OEZDOCUMENTNO);
    }

    public void setOezDocumentno(String oezDocumentno) {
        set(PROPERTY_OEZDOCUMENTNO, oezDocumentno);
    }
    ...
    public Boolean isCamIsassetpartconsumption() {
        return (Boolean) get(PROPERTY_CAMISASSETPARTCONSUMPTION);
    }

    public void setCamIsassetpartconsumption(Boolean camIsassetpartconsumption) {
        set(PROPERTY_CAMISASSETPARTCONSUMPTION, camIsassetpartconsumption);
    }
