...
public class InternalMovement extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZDOCACTION = "oezDocaction";
    ...
    public static final String PROPERTY_OEZNOVEHICLE = "oezNoVehicle";
    ...
    public InternalMovement() {
        ...
        setDefaultValue(PROPERTY_OEZDOCACTION, "AP");
    ...
    public String getOezDocaction() {
        return (String) get(PROPERTY_OEZDOCACTION);
    }

    public void setOezDocaction(String oezDocaction) {
        set(PROPERTY_OEZDOCACTION, oezDocaction);
    }
    ...
    public String getOezUnderDelivery() {
        return (String) get(PROPERTY_OEZUNDERDELIVERY);
    }

    public void setOezUnderDelivery(String oezUnderDelivery) {
        set(PROPERTY_OEZUNDERDELIVERY, oezUnderDelivery);
    }

    public String getOezOverDelivery() {
        return (String) get(PROPERTY_OEZOVERDELIVERY);
    }

    public void setOezOverDelivery(String oezOverDelivery) {
        set(PROPERTY_OEZOVERDELIVERY, oezOverDelivery);
    }

    public String getOezNoVehicle() {
        return (String) get(PROPERTY_OEZNOVEHICLE);
    }

    public void setOezNoVehicle(String oezNoVehicle) {
        set(PROPERTY_OEZNOVEHICLE, oezNoVehicle);
    }
