...
public class ShipmentInOutLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZREIMBURSEFROMIDLIST = "materialMgmtShipmentInOutLineEmOezReimbursefromIdList";
    ...
    public ShipmentInOutLine() {
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZREIMBURSEFROMIDLIST, new ArrayList<Object>());
    ...
    public ShipmentInOutLine getOezReimbursefrom() {
        return (ShipmentInOutLine) get(PROPERTY_OEZREIMBURSEFROM);
    }

    public void setOezReimbursefrom(ShipmentInOutLine oezReimbursefrom) {
    ...
    @SuppressWarnings("unchecked")
    public List<ShipmentInOutLine> getMaterialMgmtShipmentInOutLineEmOezReimbursefromIdList() {
      return (List<ShipmentInOutLine>) get(PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZREIMBURSEFROMIDLIST);
    }

    public void setMaterialMgmtShipmentInOutLineEmOezReimbursefromIdList(List<ShipmentInOutLine> materialMgmtShipmentInOutLineEmOezReimbursefromIdList) {
        set(PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZREIMBURSEFROMIDLIST, materialMgmtShipmentInOutLineEmOezReimbursefromIdList);
    }
