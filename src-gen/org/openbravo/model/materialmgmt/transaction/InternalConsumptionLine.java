...
public class InternalConsumptionLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZREQUISITIONLINE = "oezRequisitionline";
    ...
    public RequisitionLine getOezRequisitionline() {
        return (RequisitionLine) get(PROPERTY_OEZREQUISITIONLINE);
    }

    public void setOezRequisitionline(RequisitionLine oezRequisitionline) {
        set(PROPERTY_OEZREQUISITIONLINE, oezRequisitionline);
    }
