...
import org.wirabumi.fifo.model.FIFOTransaction;
...
public class Costing extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZATTRIBUTESETINSTANCE = "oezAttributesetinstance";
    public static final String PROPERTY_ORIGINALCOST = "originalCost";
    public static final String PROPERTY_OEZUSEDQTY = "oezUsedqty";
    public static final String PROPERTY_OEZSERNO = "oezSerno";
    public static final String PROPERTY_FIFOAVAILABLEQTY = "fifoAvailableqty";
    public static final String PROPERTY_FIFOFIFOTRANSACTIONLIST = "fifoFifotransactionList";
    ...
    public Costing() {
        ...
        setDefaultValue(PROPERTY_FIFOFIFOTRANSACTIONLIST, new ArrayList<Object>());
    ...
    public AttributeSetInstance getOezAttributesetinstance() {
        return (AttributeSetInstance) get(PROPERTY_OEZATTRIBUTESETINSTANCE);
    }

    public void setOezAttributesetinstance(AttributeSetInstance oezAttributesetinstance) {
        set(PROPERTY_OEZATTRIBUTESETINSTANCE, oezAttributesetinstance);
    }
    ...
    public BigDecimal getOezUsedqty() {
        return (BigDecimal) get(PROPERTY_OEZUSEDQTY);
    }

    public void setOezUsedqty(BigDecimal oezUsedqty) {
        set(PROPERTY_OEZUSEDQTY, oezUsedqty);
    }

    public String getOezSerno() {
        return (String) get(PROPERTY_OEZSERNO);
    }

    public void setOezSerno(String oezSerno) {
        set(PROPERTY_OEZSERNO, oezSerno);
    }

    public BigDecimal getFifoAvailableqty() {
        return (BigDecimal) get(PROPERTY_FIFOAVAILABLEQTY);
    }

    public void setFifoAvailableqty(BigDecimal fifoAvailableqty) {
        set(PROPERTY_FIFOAVAILABLEQTY, fifoAvailableqty);
    }

    @SuppressWarnings("unchecked")
    public List<FIFOTransaction> getFifoFifotransactionList() {
      return (List<FIFOTransaction>) get(PROPERTY_FIFOFIFOTRANSACTIONLIST);
    }

    public void setFifoFifotransactionList(List<FIFOTransaction> fifoFifotransactionList) {
        set(PROPERTY_FIFOFIFOTRANSACTIONLIST, fifoFifotransactionList);
    }
