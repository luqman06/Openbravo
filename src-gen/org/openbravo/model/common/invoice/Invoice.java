...
public class Invoice extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZCREATESALESORDER = "oezCreateSalesorder";
    public static final String PROPERTY_OEZISREIMBURSEMENT = "oezIsreimbursement";
    public static final String PROPERTY_OEZINVOICENOTES = "oezInvoiceNotes";
    public static final String PROPERTY_PREPAYMENTAMT = "prepaymentamt";
    public static final String PROPERTY_IDGENERATETAXINVOICENO = "idGeneratetaxinvoiceno";
    public static final String PROPERTY_IDNOMORFAKTURPAJAK = "idNomorfakturpajak";
    public static final String PROPERTY_IDPRINTFAKTURPAJAK = "idPrintfakturpajak";
    ...
    public static final String PROPERTY_NOMORFAKTURPAJAKVLIST = "nomorfakturpajakVList";
    ...
    public Invoice() {
        ...
        setDefaultValue(PROPERTY_OEZCREATESALESORDER, false);
        setDefaultValue(PROPERTY_OEZISREIMBURSEMENT, false);
        setDefaultValue(PROPERTY_PREPAYMENTAMT, new BigDecimal(0));
        setDefaultValue(PROPERTY_IDGENERATETAXINVOICENO, false);
        setDefaultValue(PROPERTY_IDPRINTFAKTURPAJAK, false);
        ...
        setDefaultValue(PROPERTY_NOMORFAKTURPAJAKVLIST, new ArrayList<Object>());
    }
    ...
    public Boolean isOezCreateSalesorder() {
        return (Boolean) get(PROPERTY_OEZCREATESALESORDER);
    }

    public void setOezCreateSalesorder(Boolean oezCreateSalesorder) {
        set(PROPERTY_OEZCREATESALESORDER, oezCreateSalesorder);
    }
    ...
    public String getOezInvoiceNotes() {
        return (String) get(PROPERTY_OEZINVOICENOTES);
    }

    public void setOezInvoiceNotes(String oezInvoiceNotes) {
        set(PROPERTY_OEZINVOICENOTES, oezInvoiceNotes);
    }
    ...
    public Boolean isIdGeneratetaxinvoiceno() {
        return (Boolean) get(PROPERTY_IDGENERATETAXINVOICENO);
    }

    public void setIdGeneratetaxinvoiceno(Boolean idGeneratetaxinvoiceno) {
        set(PROPERTY_IDGENERATETAXINVOICENO, idGeneratetaxinvoiceno);
    }

    public nomorfakturpajak getIdNomorfakturpajak() {
        return (nomorfakturpajak) get(PROPERTY_IDNOMORFAKTURPAJAK);
    }

    public void setIdNomorfakturpajak(nomorfakturpajak idNomorfakturpajak) {
        set(PROPERTY_IDNOMORFAKTURPAJAK, idNomorfakturpajak);
    }

    public Boolean isIdPrintfakturpajak() {
        return (Boolean) get(PROPERTY_IDPRINTFAKTURPAJAK);
    }

    public void setIdPrintfakturpajak(Boolean idPrintfakturpajak) {
        set(PROPERTY_IDPRINTFAKTURPAJAK, idPrintfakturpajak);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.dataimport.Invoice> getDataImportInvoiceList() {
      return (List<org.openbravo.model.dataimport.Invoice>) get(PROPERTY_DATAIMPORTINVOICELIST);
    }

    public void setDataImportInvoiceList(List<org.openbravo.model.dataimport.Invoice> dataImportInvoiceList) {
    ...
    @SuppressWarnings("unchecked")
    public List<id_nomorfakturpajak_v> getNomorfakturpajakVList() {
      return (List<id_nomorfakturpajak_v>) get(PROPERTY_NOMORFAKTURPAJAKVLIST);
    }

    public void setNomorfakturpajakVList(List<id_nomorfakturpajak_v> nomorfakturpajakVList) {
        set(PROPERTY_NOMORFAKTURPAJAKVLIST, nomorfakturpajakVList);
    }
