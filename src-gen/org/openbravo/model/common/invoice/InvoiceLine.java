...
public class InvoiceLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZCANCELPRICEAD = "oezCancelpricead";
    ...
    public InvoiceLine() {
        ...
        setDefaultValue(PROPERTY_OEZCANCELPRICEAD, false);
    ...
    public Boolean isOezCancelpricead() {
        return (Boolean) get(PROPERTY_OEZCANCELPRICEAD);
    }

    public void setOezCancelpricead(Boolean oezCancelpricead) {
        set(PROPERTY_OEZCANCELPRICEAD, oezCancelpricead);
    }
