...
public class Location extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_HRISISCURRENTADDR = "hrisIscurrentaddr";
    public static final String PROPERTY_IDALAMATNPWP = "idAlamatnpwp";
    ...
    public static final String PROPERTY_DATAIMPORTORDERINVOICEADDRESSLIST = "dataImportOrderInvoiceAddressList";
    ...
    public static final String PROPERTY_OEZIINOUTDELIVERYLOCATIONIDLIST = "oEZIInoutDeliveryLocationIDList";
    ...
    public Location() {
        ...
        setDefaultValue(PROPERTY_HRISISCURRENTADDR, true);
        ...
        setDefaultValue(PROPERTY_DATAIMPORTORDERINVOICEADDRESSLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OEZIINOUTDELIVERYLOCATIONIDLIST, new ArrayList<Object>());
    ...
    public Boolean isHrisIscurrentaddr() {
        return (Boolean) get(PROPERTY_HRISISCURRENTADDR);
    }

    public void setHrisIscurrentaddr(Boolean hrisIscurrentaddr) {
        set(PROPERTY_HRISISCURRENTADDR, hrisIscurrentaddr);
    }

    public String getIdAlamatnpwp() {
        return (String) get(PROPERTY_IDALAMATNPWP);
    }

    public void setIdAlamatnpwp(String idAlamatnpwp) {
        set(PROPERTY_IDALAMATNPWP, idAlamatnpwp);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Order> getDataImportOrderInvoiceAddressList() {
      return (List<Order>) get(PROPERTY_DATAIMPORTORDERINVOICEADDRESSLIST);
    }

    public void setDataImportOrderInvoiceAddressList(List<Order> dataImportOrderInvoiceAddressList) {
        set(PROPERTY_DATAIMPORTORDERINVOICEADDRESSLIST, dataImportOrderInvoiceAddressList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OEZ_I_Inout> getOEZIInoutDeliveryLocationIDList() {
      return (List<OEZ_I_Inout>) get(PROPERTY_OEZIINOUTDELIVERYLOCATIONIDLIST);
    }

    public void setOEZIInoutDeliveryLocationIDList(List<OEZ_I_Inout> oEZIInoutDeliveryLocationIDList) {
        set(PROPERTY_OEZIINOUTDELIVERYLOCATIONIDLIST, oEZIInoutDeliveryLocationIDList);
    }

    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.order.Order> getOrderInvoiceAddressList() {
      return (List<org.openbravo.model.common.order.Order>) get(PROPERTY_ORDERINVOICEADDRESSLIST);
    }

    public void setOrderInvoiceAddressList(List<org.openbravo.model.common.order.Order> orderInvoiceAddressList) {
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.order.Order> getOrderDropShipLocationList() {
      return (List<org.openbravo.model.common.order.Order>) get(PROPERTY_ORDERDROPSHIPLOCATIONLIST);
    }

    public void setOrderDropShipLocationList(List<org.openbravo.model.common.order.Order> orderDropShipLocationList) {
        set(PROPERTY_ORDERDROPSHIPLOCATIONLIST, orderDropShipLocationList);
    }

    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.order.Order> getOrderDeliveryLocationList() {
      return (List<org.openbravo.model.common.order.Order>) get(PROPERTY_ORDERDELIVERYLOCATIONLIST);
    }

    public void setOrderDeliveryLocationList(List<org.openbravo.model.common.order.Order> orderDeliveryLocationList) {
