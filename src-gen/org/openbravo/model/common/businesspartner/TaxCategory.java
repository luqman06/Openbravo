...
public class TaxCategory extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public List<BusinessPartner> getBusinessPartnerTaxCategoryList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNERTAXCATEGORYLIST);
    }

    public void setBusinessPartnerTaxCategoryList(List<BusinessPartner> businessPartnerTaxCategoryList) {
        set(PROPERTY_BUSINESSPARTNERTAXCATEGORYLIST, businessPartnerTaxCategoryList);
    }

    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerSOBPTaxCategoryList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNERSOBPTAXCATEGORYLIST);
    }
