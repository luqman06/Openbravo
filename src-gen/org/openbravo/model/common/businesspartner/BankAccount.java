...
public class BankAccount extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PYRISPAYROLL = "pyrIspayroll";
    ...
    public BankAccount() {
        ...
        setDefaultValue(PROPERTY_PYRISPAYROLL, false);
    }
    ...
    public Boolean isPyrIspayroll() {
        return (Boolean) get(PROPERTY_PYRISPAYROLL);
    }

    public void setPyrIspayroll(Boolean pyrIspayroll) {
        set(PROPERTY_PYRISPAYROLL, pyrIspayroll);
    }
