...
public class Category extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_HRISISEMPLOYEE = "hrisIsemployee";
    ...
    public Category() {
        ...
        setDefaultValue(PROPERTY_HRISISEMPLOYEE, false);
    ...
    public Boolean isHrisIsemployee() {
        return (Boolean) get(PROPERTY_HRISISEMPLOYEE);
    }

    public void setHrisIsemployee(Boolean hrisIsemployee) {
        set(PROPERTY_HRISISEMPLOYEE, hrisIsemployee);
    }
