...
import org.wirabumi.gen.oez.oez_shipment_proposal;
...
public class Country extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_BUSINESSPARTNEREMHRISNATIONALITYIDLIST = "businessPartnerEmHrisNationalityIdList";
    ...
    public static final String PROPERTY_DATAIMPORTTAXDESTINATIONCOUNTRYLIST = "dataImportTaxDestinationCountryList";
    ...
    public static final String PROPERTY_MATERIALMGMTSHIPMENTINOUTEMOEZDESTPORTCOUNTRYIDLIST = "materialMgmtShipmentInOutEMOezDestPortCountryIDList";
    public static final String PROPERTY_OEZIINOUTLIST = "oEZIInoutList";
    public static final String PROPERTY_OEZIINOUTCSHIPCOUNTRYIDLIST = "oEZIInoutCShipCountryIDList";
    ...
    public static final String PROPERTY_HRISECLINESNATIONALITYLIST = "hrisEcLinesNationalityList";
    public static final String PROPERTY_HRISECLINESLIST = "hrisEcLinesList";
    public static final String PROPERTY_HRISIEMPLOYEECANDIDATENATIONALITYLIST = "hrisIEmployeeCandidateNationalityList";
    public static final String PROPERTY_HRISIEMPLOYEECANDIDATELIST = "hrisIEmployeeCandidateList";
    public static final String PROPERTY_OEZSHIPMENTPROPOSALLOADINGPORTCOUNTRYLIST = "oezShipmentProposalLoadingPortCountryList";
    public static final String PROPERTY_OEZSHIPMENTPROPOSALDESTINATIONPORTCOUNTRYLIST = "oezShipmentProposalDestinationPortCountryList";
    public static final String PROPERTY_OEZSHIPMENTDATALOADINGPORTCOUNTRYLIST = "oezShipmentdataLoadingPortCountryList";
    public static final String PROPERTY_OEZSHIPMENTDATADESTINATIONPORTCOUNTRYLIST = "oezShipmentdataDestinationPortCountryList";
    ...
    public Country() {
        ...
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMHRISNATIONALITYIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_DATAIMPORTTAXDESTINATIONCOUNTRYLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTSHIPMENTINOUTEMOEZDESTPORTCOUNTRYIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZIINOUTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZIINOUTCSHIPCOUNTRYIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_HRISECLINESNATIONALITYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_HRISECLINESLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_HRISIEMPLOYEECANDIDATENATIONALITYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_HRISIEMPLOYEECANDIDATELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSHIPMENTPROPOSALLOADINGPORTCOUNTRYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSHIPMENTPROPOSALDESTINATIONPORTCOUNTRYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSHIPMENTDATALOADINGPORTCOUNTRYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSHIPMENTDATADESTINATIONPORTCOUNTRYLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEmHrisNationalityIdList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMHRISNATIONALITYIDLIST);
    }

    public void setBusinessPartnerEmHrisNationalityIdList(List<BusinessPartner> businessPartnerEmHrisNationalityIdList) {
        set(PROPERTY_BUSINESSPARTNEREMHRISNATIONALITYIDLIST, businessPartnerEmHrisNationalityIdList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Tax> getDataImportTaxDestinationCountryList() {
      return (List<Tax>) get(PROPERTY_DATAIMPORTTAXDESTINATIONCOUNTRYLIST);
    }

    public void setDataImportTaxDestinationCountryList(List<Tax> dataImportTaxDestinationCountryList) {
        set(PROPERTY_DATAIMPORTTAXDESTINATIONCOUNTRYLIST, dataImportTaxDestinationCountryList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ShipmentInOut> getMaterialMgmtShipmentInOutEMOezDestPortCountryIDList() {
      return (List<ShipmentInOut>) get(PROPERTY_MATERIALMGMTSHIPMENTINOUTEMOEZDESTPORTCOUNTRYIDLIST);
    }

    public void setMaterialMgmtShipmentInOutEMOezDestPortCountryIDList(List<ShipmentInOut> materialMgmtShipmentInOutEMOezDestPortCountryIDList) {
        set(PROPERTY_MATERIALMGMTSHIPMENTINOUTEMOEZDESTPORTCOUNTRYIDLIST, materialMgmtShipmentInOutEMOezDestPortCountryIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<OEZ_I_Inout> getOEZIInoutCShipCountryIDList() {
      return (List<OEZ_I_Inout>) get(PROPERTY_OEZIINOUTCSHIPCOUNTRYIDLIST);
    }

    public void setOEZIInoutCShipCountryIDList(List<OEZ_I_Inout> oEZIInoutCShipCountryIDList) {
        set(PROPERTY_OEZIINOUTCSHIPCOUNTRYIDLIST, oEZIInoutCShipCountryIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<hris_ec_lines> getHrisEcLinesNationalityList() {
      return (List<hris_ec_lines>) get(PROPERTY_HRISECLINESNATIONALITYLIST);
    }

    public void setHrisEcLinesNationalityList(List<hris_ec_lines> hrisEcLinesNationalityList) {
        set(PROPERTY_HRISECLINESNATIONALITYLIST, hrisEcLinesNationalityList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<hris_i_employee_candidate> getHrisIEmployeeCandidateNationalityList() {
      return (List<hris_i_employee_candidate>) get(PROPERTY_HRISIEMPLOYEECANDIDATENATIONALITYLIST);
    }

    public void setHrisIEmployeeCandidateNationalityList(List<hris_i_employee_candidate> hrisIEmployeeCandidateNationalityList) {
        set(PROPERTY_HRISIEMPLOYEECANDIDATENATIONALITYLIST, hrisIEmployeeCandidateNationalityList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_shipment_proposal> getOezShipmentProposalLoadingPortCountryList() {
      return (List<oez_shipment_proposal>) get(PROPERTY_OEZSHIPMENTPROPOSALLOADINGPORTCOUNTRYLIST);
    }

    public void setOezShipmentProposalLoadingPortCountryList(List<oez_shipment_proposal> oezShipmentProposalLoadingPortCountryList) {
        set(PROPERTY_OEZSHIPMENTPROPOSALLOADINGPORTCOUNTRYLIST, oezShipmentProposalLoadingPortCountryList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_shipment_proposal> getOezShipmentProposalDestinationPortCountryList() {
      return (List<oez_shipment_proposal>) get(PROPERTY_OEZSHIPMENTPROPOSALDESTINATIONPORTCOUNTRYLIST);
    }

    public void setOezShipmentProposalDestinationPortCountryList(List<oez_shipment_proposal> oezShipmentProposalDestinationPortCountryList) {
        set(PROPERTY_OEZSHIPMENTPROPOSALDESTINATIONPORTCOUNTRYLIST, oezShipmentProposalDestinationPortCountryList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_shipmentdata> getOezShipmentdataLoadingPortCountryList() {
      return (List<oez_shipmentdata>) get(PROPERTY_OEZSHIPMENTDATALOADINGPORTCOUNTRYLIST);
    }

    public void setOezShipmentdataLoadingPortCountryList(List<oez_shipmentdata> oezShipmentdataLoadingPortCountryList) {
        set(PROPERTY_OEZSHIPMENTDATALOADINGPORTCOUNTRYLIST, oezShipmentdataLoadingPortCountryList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_shipmentdata> getOezShipmentdataDestinationPortCountryList() {
      return (List<oez_shipmentdata>) get(PROPERTY_OEZSHIPMENTDATADESTINATIONPORTCOUNTRYLIST);
    }

    public void setOezShipmentdataDestinationPortCountryList(List<oez_shipmentdata> oezShipmentdataDestinationPortCountryList) {
        set(PROPERTY_OEZSHIPMENTDATADESTINATIONPORTCOUNTRYLIST, oezShipmentdataDestinationPortCountryList);
    }
