...
public class UOM extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_HRISKPILIST = "hrisKpiList";
    ...
    public UOM() {
        ...
        setDefaultValue(PROPERTY_HRISKPILIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.plm.Product> getProductUOMForWeightList() {
      return (List<org.openbravo.model.common.plm.Product>) get(PROPERTY_PRODUCTUOMFORWEIGHTLIST);
    }

    public void setProductUOMForWeightList(List<org.openbravo.model.common.plm.Product> productUOMForWeightList) {
    ...
    @SuppressWarnings("unchecked")
    public List<hris_kpi> getHrisKpiList() {
      return (List<hris_kpi>) get(PROPERTY_HRISKPILIST);
    }

    public void setHrisKpiList(List<hris_kpi> hrisKpiList) {
        set(PROPERTY_HRISKPILIST, hrisKpiList);
    }
