...
public class OrderLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZORDERLINEIDLINK = "oezOrderlineIdLink";
    ...
    public static final String PROPERTY_OEZREQUESTEDQTY = "oezRequestedqty";
    public static final String PROPERTY_OEZFLAGDELIVERYCOMPLETED = "oezFlagdeliveryCompleted";
    public static final String PROPERTY_OEZAUMQTYORDERED = "oezAumQtyordered";
    public static final String PROPERTY_OEZQTYPLAN = "oezQtyPlan";
    ...
    public static final String PROPERTY_ORDERLINEEMOEZORDERLINEIDLINKLIST = "orderLineEMOezOrderlineIdLinkList";
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONLINEEMOEZSALESORDERLINEIDLIST = "procurementRequisitionLineEMOezSalesorderlineIDList";
    public static final String PROPERTY_PROCUREMENTREQUISITIONPOMATCHLIST = "procurementRequisitionPOMatchList";
    public static final String PROPERTY_PROJECTLINEEMPBIDORDERLINEIDLIST = "projectLineEmPbidOrderlineIdList";
    public static final String PROPERTY_PROJECTPROPOSALLINEEMPBIDORDERLINEIDLIST = "projectProposalLineEmPbidOrderlineIdList";
    ...
    public static final String PROPERTY_REALIZEDUSAGELIST = "realizedusageList";
    ...
    // nor OBCriteria. 
    public static final String COMPUTED_COLUMN_OEZGRQUANTITY = "oezGrQuantity";
    ...
    public OrderLine() {
        ...
        setDefaultValue(PROPERTY_OEZAUMPRICEACTUAL, new BigDecimal(0));
        setDefaultValue(PROPERTY_OEZFLAGDELIVERYCOMPLETED, false);
        ...
        setDefaultValue(PROPERTY_ORDERLINEEMOEZORDERLINEIDLINKLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONLINEEMOEZSALESORDERLINEIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONPOMATCHLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROJECTLINEEMPBIDORDERLINEIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROJECTPROPOSALLINEEMPBIDORDERLINEIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_REALIZEDUSAGELIST, new ArrayList<Object>());
    ...
    public OrderLine getOezOrderlineIdLink() {
        return (OrderLine) get(PROPERTY_OEZORDERLINEIDLINK);
    }

    public void setOezOrderlineIdLink(OrderLine oezOrderlineIdLink) {
        set(PROPERTY_OEZORDERLINEIDLINK, oezOrderlineIdLink);
    }
    ...
    public BigDecimal getOezRequestedqty() {
        return (BigDecimal) get(PROPERTY_OEZREQUESTEDQTY);
    }

    public void setOezRequestedqty(BigDecimal oezRequestedqty) {
        set(PROPERTY_OEZREQUESTEDQTY, oezRequestedqty);
    }

    public Boolean isOezFlagdeliveryCompleted() {
        return (Boolean) get(PROPERTY_OEZFLAGDELIVERYCOMPLETED);
    }

    public void setOezFlagdeliveryCompleted(Boolean oezFlagdeliveryCompleted) {
        set(PROPERTY_OEZFLAGDELIVERYCOMPLETED, oezFlagdeliveryCompleted);
    }
    ...
    public Long getOezQtyPlan() {
        return (Long) get(PROPERTY_OEZQTYPLAN);
    }

    public void setOezQtyPlan(Long oezQtyPlan) {
        set(PROPERTY_OEZQTYPLAN, oezQtyPlan);
    }

    public BigDecimal getOezGrQuantity() {
        return (BigDecimal) get(COMPUTED_COLUMN_OEZGRQUANTITY);
    }

    public void setOezGrQuantity(BigDecimal oezGrQuantity) {
        set(COMPUTED_COLUMN_OEZGRQUANTITY, oezGrQuantity);
    }
    ...
    public List<org.openbravo.model.dataimport.Order> getDataImportOrderList() {
      return (List<org.openbravo.model.dataimport.Order>) get(PROPERTY_DATAIMPORTORDERLIST);
    }

    public void setDataImportOrderList(List<org.openbravo.model.dataimport.Order> dataImportOrderList) {
    ...
    @SuppressWarnings("unchecked")
    public List<OrderLine> getOrderLineEMOezOrderlineIdLinkList() {
      return (List<OrderLine>) get(PROPERTY_ORDERLINEEMOEZORDERLINEIDLINKLIST);
    }

    public void setOrderLineEMOezOrderlineIdLinkList(List<OrderLine> orderLineEMOezOrderlineIdLinkList) {
        set(PROPERTY_ORDERLINEEMOEZORDERLINEIDLINKLIST, orderLineEMOezOrderlineIdLinkList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<RequisitionLine> getProcurementRequisitionLineEMOezSalesorderlineIDList() {
      return (List<RequisitionLine>) get(PROPERTY_PROCUREMENTREQUISITIONLINEEMOEZSALESORDERLINEIDLIST);
    }

    public void setProcurementRequisitionLineEMOezSalesorderlineIDList(List<RequisitionLine> procurementRequisitionLineEMOezSalesorderlineIDList) {
        set(PROPERTY_PROCUREMENTREQUISITIONLINEEMOEZSALESORDERLINEIDLIST, procurementRequisitionLineEMOezSalesorderlineIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ProjectLine> getProjectLineEmPbidOrderlineIdList() {
      return (List<ProjectLine>) get(PROPERTY_PROJECTLINEEMPBIDORDERLINEIDLIST);
    }

    public void setProjectLineEmPbidOrderlineIdList(List<ProjectLine> projectLineEmPbidOrderlineIdList) {
        set(PROPERTY_PROJECTLINEEMPBIDORDERLINEIDLIST, projectLineEmPbidOrderlineIdList);
    }

    @SuppressWarnings("unchecked")
    public List<ProjectProposalLine> getProjectProposalLineEmPbidOrderlineIdList() {
      return (List<ProjectProposalLine>) get(PROPERTY_PROJECTPROPOSALLINEEMPBIDORDERLINEIDLIST);
    }

    public void setProjectProposalLineEmPbidOrderlineIdList(List<ProjectProposalLine> projectProposalLineEmPbidOrderlineIdList) {
        set(PROPERTY_PROJECTPROPOSALLINEEMPBIDORDERLINEIDLIST, projectProposalLineEmPbidOrderlineIdList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<RealizedBudgetUsage> getRealizedusageList() {
      return (List<RealizedBudgetUsage>) get(PROPERTY_REALIZEDUSAGELIST);
    }

    public void setRealizedusageList(List<RealizedBudgetUsage> realizedusageList) {
        set(PROPERTY_REALIZEDUSAGELIST, realizedusageList);
    }
    ...
    public Object get(String propName) {
      if (COMPUTED_COLUMN_OEZGRQUANTITY.equals(propName)) {
        if (get_computedColumns() == null) {
          return null;
        }
        return get_computedColumns().getOezGrQuantity();
      }
