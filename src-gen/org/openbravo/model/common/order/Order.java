...
public class Order extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZREVIEWSO = "oezReviewso";
    public static final String PROPERTY_OEZISVALIDRECORD = "oezIsvalidrecord";
    public static final String PROPERTY_OEZCREATEPURCHASEORDER = "oezCreatePurchaseorder";
    ...
    public static final String PROPERTY_OEZDESTINATIONPORT = "oezDestinationPort";
    ...
    public static final String PROPERTY_OEZSETPODELIVERYCOMPLETE = "oezSetPodeliveryComplete";
    ...
    public static final String PROPERTY_CAMWORKORDER = "camWorkorder";
    ...
    public static final String PROPERTY_PROJECTEMPBIDORDERIDLIST = "projectEmPbidOrderIdList";
    ...
    public static final String PROPERTY_PROJECTPROPOSALEMPBIDORDERIDLIST = "projectProposalEmPbidOrderIdList";
    public static final String PROPERTY_OEZSHIPMENTPROPOSALLIST = "oezShipmentProposalList";
    ...
    public Order() {
        ...
        setDefaultValue(PROPERTY_FREIGHTCOSTRULE, "oez_freight_collect");
        ...
        setDefaultValue(PROPERTY_OEZREVIEWSO, false);
        setDefaultValue(PROPERTY_OEZISVALIDRECORD, false);
        setDefaultValue(PROPERTY_OEZCREATEPURCHASEORDER, false);
        setDefaultValue(PROPERTY_OEZUNDERDELIVERY, (long) 0);
        setDefaultValue(PROPERTY_OEZOVERDELIVERY, (long) 0);
        setDefaultValue(PROPERTY_OEZSETPODELIVERYCOMPLETE, false);
        ...
        setDefaultValue(PROPERTY_PROJECTEMPBIDORDERIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_PROJECTPROPOSALEMPBIDORDERIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSHIPMENTPROPOSALLIST, new ArrayList<Object>());
    }
    ...
    public Boolean isOezReviewso() {
        return (Boolean) get(PROPERTY_OEZREVIEWSO);
    }

    public void setOezReviewso(Boolean oezReviewso) {
        set(PROPERTY_OEZREVIEWSO, oezReviewso);
    }

    public Boolean isOezIsvalidrecord() {
        return (Boolean) get(PROPERTY_OEZISVALIDRECORD);
    }

    public void setOezIsvalidrecord(Boolean oezIsvalidrecord) {
        set(PROPERTY_OEZISVALIDRECORD, oezIsvalidrecord);
    }

    public Boolean isOezCreatePurchaseorder() {
        return (Boolean) get(PROPERTY_OEZCREATEPURCHASEORDER);
    }

    public void setOezCreatePurchaseorder(Boolean oezCreatePurchaseorder) {
        set(PROPERTY_OEZCREATEPURCHASEORDER, oezCreatePurchaseorder);
    }
    ...
    public String getOezDestinationPort() {
        return (String) get(PROPERTY_OEZDESTINATIONPORT);
    }

    public void setOezDestinationPort(String oezDestinationPort) {
        set(PROPERTY_OEZDESTINATIONPORT, oezDestinationPort);
    }
    ...
    public Boolean isOezSetPodeliveryComplete() {
        return (Boolean) get(PROPERTY_OEZSETPODELIVERYCOMPLETE);
    }

    public void setOezSetPodeliveryComplete(Boolean oezSetPodeliveryComplete) {
        set(PROPERTY_OEZSETPODELIVERYCOMPLETE, oezSetPodeliveryComplete);
    }
    ...
    public WorkOrder getCamWorkorder() {
        return (WorkOrder) get(PROPERTY_CAMWORKORDER);
    }

    public void setCamWorkorder(WorkOrder camWorkorder) {
        set(PROPERTY_CAMWORKORDER, camWorkorder);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Project> getProjectEmPbidOrderIdList() {
      return (List<Project>) get(PROPERTY_PROJECTEMPBIDORDERIDLIST);
    }

    public void setProjectEmPbidOrderIdList(List<Project> projectEmPbidOrderIdList) {
        set(PROPERTY_PROJECTEMPBIDORDERIDLIST, projectEmPbidOrderIdList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ProjectProposal> getProjectProposalEmPbidOrderIdList() {
      return (List<ProjectProposal>) get(PROPERTY_PROJECTPROPOSALEMPBIDORDERIDLIST);
    }

    public void setProjectProposalEmPbidOrderIdList(List<ProjectProposal> projectProposalEmPbidOrderIdList) {
        set(PROPERTY_PROJECTPROPOSALEMPBIDORDERIDLIST, projectProposalEmPbidOrderIdList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_shipment_proposal> getOezShipmentProposalList() {
      return (List<oez_shipment_proposal>) get(PROPERTY_OEZSHIPMENTPROPOSALLIST);
    }

    public void setOezShipmentProposalList(List<oez_shipment_proposal> oezShipmentProposalList) {
        set(PROPERTY_OEZSHIPMENTPROPOSALLIST, oezShipmentProposalList);
    }
