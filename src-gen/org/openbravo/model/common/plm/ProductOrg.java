...
public class ProductOrg extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZREORDERPOINT = "oezReorderpoint";
    public static final String PROPERTY_OEZSAFETYSTOCKINDAYS = "oezSafetystockindays";

    public ProductOrg() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_OEZREORDERPOINT, new BigDecimal(0));
        setDefaultValue(PROPERTY_OEZSAFETYSTOCKINDAYS, new BigDecimal(0));
    }
    ...
    public BigDecimal getOezReorderpoint() {
        return (BigDecimal) get(PROPERTY_OEZREORDERPOINT);
    }

    public void setOezReorderpoint(BigDecimal oezReorderpoint) {
        set(PROPERTY_OEZREORDERPOINT, oezReorderpoint);
    }

    public BigDecimal getOezSafetystockindays() {
        return (BigDecimal) get(PROPERTY_OEZSAFETYSTOCKINDAYS);
    }

    public void setOezSafetystockindays(BigDecimal oezSafetystockindays) {
        set(PROPERTY_OEZSAFETYSTOCKINDAYS, oezSafetystockindays);
    }
