...
public class ProductCategory extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PRODUCTEMOEZPARENTGROUPIDLIST = "productEmOezParentgroupIdList";
    ...
    public ProductCategory() {
        ...
        setDefaultValue(PROPERTY_PRODUCTEMOEZPARENTGROUPIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.plm.Product> getProductEmOezParentgroupIdList() {
      return (List<org.openbravo.model.common.plm.Product>) get(PROPERTY_PRODUCTEMOEZPARENTGROUPIDLIST);
    }

    public void setProductEmOezParentgroupIdList(List<org.openbravo.model.common.plm.Product> productEmOezParentgroupIdList) {
        set(PROPERTY_PRODUCTEMOEZPARENTGROUPIDLIST, productEmOezParentgroupIdList);
    }
