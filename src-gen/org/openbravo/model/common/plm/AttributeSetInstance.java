...
public class AttributeSetInstance extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_MATERIALMGMTCOSTINGEMOEZATTRIBUTESETINSTANCEIDLIST = "materialMgmtCostingEMOezAttributesetinstanceIDList";
    ...
    public static final String PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZATTRIBUTESETINSTANCEIDLIST = "materialMgmtShipmentInOutLineEmOezAttributesetinstanceIdList";
    ...
    public AttributeSetInstance() {
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTCOSTINGEMOEZATTRIBUTESETINSTANCEIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZATTRIBUTESETINSTANCEIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Costing> getMaterialMgmtCostingEMOezAttributesetinstanceIDList() {
      return (List<Costing>) get(PROPERTY_MATERIALMGMTCOSTINGEMOEZATTRIBUTESETINSTANCEIDLIST);
    }

    public void setMaterialMgmtCostingEMOezAttributesetinstanceIDList(List<Costing> materialMgmtCostingEMOezAttributesetinstanceIDList) {
        set(PROPERTY_MATERIALMGMTCOSTINGEMOEZATTRIBUTESETINSTANCEIDLIST, materialMgmtCostingEMOezAttributesetinstanceIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ShipmentInOutLine> getMaterialMgmtShipmentInOutLineEmOezAttributesetinstanceIdList() {
      return (List<ShipmentInOutLine>) get(PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZATTRIBUTESETINSTANCEIDLIST);
    }

    public void setMaterialMgmtShipmentInOutLineEmOezAttributesetinstanceIdList(List<ShipmentInOutLine> materialMgmtShipmentInOutLineEmOezAttributesetinstanceIdList) {
        set(PROPERTY_MATERIALMGMTSHIPMENTINOUTLINEEMOEZATTRIBUTESETINSTANCEIDLIST, materialMgmtShipmentInOutLineEmOezAttributesetinstanceIdList);
    }
