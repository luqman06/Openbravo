...
import org.openbravo.model.dataimport.Inventory;
...
import org.wirabumi.gen.oez.LaporanLPP;
import org.wirabumi.gen.oez.OEZ_I_Inout;
import org.wirabumi.gen.oez.ProductFlavour;
import org.wirabumi.gen.oez.SalesPerformance;
import org.wirabumi.gen.oez.importmasterdata.ImportWorkEffort;
import org.wirabumi.gen.oez.importmasterdata.oez_i_productcost;
import org.wirabumi.gen.oez.importmasterdata.oez_i_productprice;
import org.wirabumi.gen.oez.importtrialbalance.oez_i_inventory;
import org.wirabumi.gen.oez.oez_prod_octopus;
import org.wirabumi.gen.oez.oez_stockaging;
import org.wirabumi.gen.oez.oez_summary_lot_no;
import org.wirabumi.stockreservation.SR_StockReservation;
/**
...
public class Product extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZPRODUCTFLAVOUR = "oezProductflavour";
    ...
    public static final String PROPERTY_OEZTAG = "oezTag";
    public static final String PROPERTY_OEZPARENTGROUP = "oezParentgroup";
    public static final String PROPERTY_OEZGROSSWEIGHT = "oezGrossWeight";
    public static final String PROPERTY_OEZPACKAGINGSIZE = "oezPackagingSize";
    public static final String PROPERTY_OEZPACKAGING = "oezPackaging";
    public static final String PROPERTY_PRODUCTSTATUS = "productStatus";
    public static final String PROPERTY_OEZFROZENTYPE = "oezFrozenType";
    public static final String PROPERTY_OEZTYPEOFGOODS = "oezTypeOfGoods";
    public static final String PROPERTY_OEZPROCESSINGTYPE = "oezProcessingType";
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETEMCAMROTATINGITEMIDLIST = "financialMgmtAssetEmCamRotatingitemIdList";
    ...
    public static final String PROPERTY_OEZIWORKEFFORTLIST = "oEZIWorkeffortList";
    ...
    public static final String PROPERTY_OEZIINVENTORYLIST = "oezIInventoryList";
    public static final String PROPERTY_OEZIPRODUCTCOSTLIST = "oezIProductcostList";
    public static final String PROPERTY_OEZIPRODUCTPRICELIST = "oezIProductpriceList";
    public static final String PROPERTY_OEZLAPORANLPPLIST = "oezLaporanLppList";
    public static final String PROPERTY_OEZPRODOCTOPUSLIST = "oezProdOctopusList";
    public static final String PROPERTY_OEZSALESPREFORMANCELIST = "oezSalespreformanceList";
    public static final String PROPERTY_OEZSTOCKAGINGLIST = "oezStockagingList";
    public static final String PROPERTY_OEZSUMMARYLOTNOLIST = "oezSummaryLotNoList";
    public static final String PROPERTY_STOCKRESERVATIONLIST = "stockreservationList";
    ...
    public Product() {
        ...
        setDefaultValue(PROPERTY_OEZUNDERDELIVERY, new BigDecimal(0));
        setDefaultValue(PROPERTY_OEZOVERDELIVERY, new BigDecimal(0));
        setDefaultValue(PROPERTY_OEZGROSSWEIGHT, new BigDecimal(0));
        setDefaultValue(PROPERTY_CAMROTATINGITEM, false);
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETEMCAMROTATINGITEMIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OEZIWORKEFFORTLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OEZIINVENTORYLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZIPRODUCTCOSTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZIPRODUCTPRICELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZLAPORANLPPLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZPRODOCTOPUSLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSALESPREFORMANCELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSTOCKAGINGLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZSUMMARYLOTNOLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_STOCKRESERVATIONLIST, new ArrayList<Object>());
    }
    ...
    public ProductFlavour getOezProductflavour() {
        return (ProductFlavour) get(PROPERTY_OEZPRODUCTFLAVOUR);
    }

    public void setOezProductflavour(ProductFlavour oezProductflavour) {
        set(PROPERTY_OEZPRODUCTFLAVOUR, oezProductflavour);
    }
    ...
    public BigDecimal getOezUnderDelivery() {
        return (BigDecimal) get(PROPERTY_OEZUNDERDELIVERY);
    }

    public void setOezUnderDelivery(BigDecimal oezUnderDelivery) {
        set(PROPERTY_OEZUNDERDELIVERY, oezUnderDelivery);
    }

    public BigDecimal getOezOverDelivery() {
        return (BigDecimal) get(PROPERTY_OEZOVERDELIVERY);
    }

    public void setOezOverDelivery(BigDecimal oezOverDelivery) {
        set(PROPERTY_OEZOVERDELIVERY, oezOverDelivery);
    }

    public String getOezTag() {
        return (String) get(PROPERTY_OEZTAG);
    }

    public void setOezTag(String oezTag) {
        set(PROPERTY_OEZTAG, oezTag);
    }

    public ProductCategory getOezParentgroup() {
        return (ProductCategory) get(PROPERTY_OEZPARENTGROUP);
    }

    public void setOezParentgroup(ProductCategory oezParentgroup) {
        set(PROPERTY_OEZPARENTGROUP, oezParentgroup);
    }

    public BigDecimal getOezGrossWeight() {
        return (BigDecimal) get(PROPERTY_OEZGROSSWEIGHT);
    }

    public void setOezGrossWeight(BigDecimal oezGrossWeight) {
        set(PROPERTY_OEZGROSSWEIGHT, oezGrossWeight);
    }

    public String getOezPackagingSize() {
        return (String) get(PROPERTY_OEZPACKAGINGSIZE);
    }

    public void setOezPackagingSize(String oezPackagingSize) {
        set(PROPERTY_OEZPACKAGINGSIZE, oezPackagingSize);
    }

    public String getOezPackaging() {
        return (String) get(PROPERTY_OEZPACKAGING);
    }

    public void setOezPackaging(String oezPackaging) {
        set(PROPERTY_OEZPACKAGING, oezPackaging);
    }
    ...
    public String getOezFrozenType() {
        return (String) get(PROPERTY_OEZFROZENTYPE);
    }

    public void setOezFrozenType(String oezFrozenType) {
        set(PROPERTY_OEZFROZENTYPE, oezFrozenType);
    }
    ...
    public String getOezProcessingType() {
        return (String) get(PROPERTY_OEZPROCESSINGTYPE);
    }

    public void setOezProcessingType(String oezProcessingType) {
        set(PROPERTY_OEZPROCESSINGTYPE, oezProcessingType);
    }
    ...
    public Boolean isCamRotatingitem() {
        return (Boolean) get(PROPERTY_CAMROTATINGITEM);
    }

    public void setCamRotatingitem(Boolean camRotatingitem) {
    ...
    @SuppressWarnings("unchecked")
    public List<Inventory> getDataImportInventoryList() {
      return (List<Inventory>) get(PROPERTY_DATAIMPORTINVENTORYLIST);
    }

    public void setDataImportInventoryList(List<Inventory> dataImportInventoryList) {
        set(PROPERTY_DATAIMPORTINVENTORYLIST, dataImportInventoryList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.dataimport.Product> getDataImportProductList() {
      return (List<org.openbravo.model.dataimport.Product>) get(PROPERTY_DATAIMPORTPRODUCTLIST);
    }

    public void setDataImportProductList(List<org.openbravo.model.dataimport.Product> dataImportProductList) {
    ...
    @SuppressWarnings("unchecked")
    public List<Asset> getFinancialMgmtAssetEmCamRotatingitemIdList() {
      return (List<Asset>) get(PROPERTY_FINANCIALMGMTASSETEMCAMROTATINGITEMIDLIST);
    }

    public void setFinancialMgmtAssetEmCamRotatingitemIdList(List<Asset> financialMgmtAssetEmCamRotatingitemIdList) {
        set(PROPERTY_FINANCIALMGMTASSETEMCAMROTATINGITEMIDLIST, financialMgmtAssetEmCamRotatingitemIdList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ImportWorkEffort> getOEZIWorkeffortList() {
      return (List<ImportWorkEffort>) get(PROPERTY_OEZIWORKEFFORTLIST);
    }

    public void setOEZIWorkeffortList(List<ImportWorkEffort> oEZIWorkeffortList) {
        set(PROPERTY_OEZIWORKEFFORTLIST, oEZIWorkeffortList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_i_inventory> getOezIInventoryList() {
      return (List<oez_i_inventory>) get(PROPERTY_OEZIINVENTORYLIST);
    }

    public void setOezIInventoryList(List<oez_i_inventory> oezIInventoryList) {
        set(PROPERTY_OEZIINVENTORYLIST, oezIInventoryList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_i_productcost> getOezIProductcostList() {
      return (List<oez_i_productcost>) get(PROPERTY_OEZIPRODUCTCOSTLIST);
    }

    public void setOezIProductcostList(List<oez_i_productcost> oezIProductcostList) {
        set(PROPERTY_OEZIPRODUCTCOSTLIST, oezIProductcostList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_i_productprice> getOezIProductpriceList() {
      return (List<oez_i_productprice>) get(PROPERTY_OEZIPRODUCTPRICELIST);
    }

    public void setOezIProductpriceList(List<oez_i_productprice> oezIProductpriceList) {
        set(PROPERTY_OEZIPRODUCTPRICELIST, oezIProductpriceList);
    }

    @SuppressWarnings("unchecked")
    public List<LaporanLPP> getOezLaporanLppList() {
      return (List<LaporanLPP>) get(PROPERTY_OEZLAPORANLPPLIST);
    }

    public void setOezLaporanLppList(List<LaporanLPP> oezLaporanLppList) {
        set(PROPERTY_OEZLAPORANLPPLIST, oezLaporanLppList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SalesPerformance> getOezSalespreformanceList() {
      return (List<SalesPerformance>) get(PROPERTY_OEZSALESPREFORMANCELIST);
    }

    public void setOezSalespreformanceList(List<SalesPerformance> oezSalespreformanceList) {
        set(PROPERTY_OEZSALESPREFORMANCELIST, oezSalespreformanceList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_stockaging> getOezStockagingList() {
      return (List<oez_stockaging>) get(PROPERTY_OEZSTOCKAGINGLIST);
    }

    public void setOezStockagingList(List<oez_stockaging> oezStockagingList) {
        set(PROPERTY_OEZSTOCKAGINGLIST, oezStockagingList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<SR_StockReservation> getStockreservationList() {
      return (List<SR_StockReservation>) get(PROPERTY_STOCKRESERVATIONLIST);
    }

    public void setStockreservationList(List<SR_StockReservation> stockreservationList) {
        set(PROPERTY_STOCKRESERVATIONLIST, stockreservationList);
    }
