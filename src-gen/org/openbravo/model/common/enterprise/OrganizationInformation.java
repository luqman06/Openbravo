...
public class OrganizationInformation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_IDTGLPENGUKUHANPKP = "idTglpengukuhanpkp";
    public static final String PROPERTY_ISDOUBLECASH = "isDoubleCash";
    public static final String PROPERTY_IDPKP = "idPkp";
    ...
    public Date getIdTglpengukuhanpkp() {
        return (Date) get(PROPERTY_IDTGLPENGUKUHANPKP);
    }

    public void setIdTglpengukuhanpkp(Date idTglpengukuhanpkp) {
        set(PROPERTY_IDTGLPENGUKUHANPKP, idTglpengukuhanpkp);
    }
    ...
    public User getIdPkp() {
        return (User) get(PROPERTY_IDPKP);
    }

    public void setIdPkp(User idPkp) {
        set(PROPERTY_IDPKP, idPkp);
    }
