...
public class Warehouse extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZIDDISTRIBUTIONCENTER = "oezIddistributioncenter";
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONEMPBIDWAREHOUSEIDLIST = "procurementRequisitionEmPbidWarehouseIdList";
    ...
    public Warehouse() {
        ...
        setDefaultValue(PROPERTY_OEZIDDISTRIBUTIONCENTER, false);
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONEMPBIDWAREHOUSEIDLIST, new ArrayList<Object>());
    ...
    public Boolean isOezIddistributioncenter() {
        return (Boolean) get(PROPERTY_OEZIDDISTRIBUTIONCENTER);
    }

    public void setOezIddistributioncenter(Boolean oezIddistributioncenter) {
        set(PROPERTY_OEZIDDISTRIBUTIONCENTER, oezIddistributioncenter);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Requisition> getProcurementRequisitionEmPbidWarehouseIdList() {
      return (List<Requisition>) get(PROPERTY_PROCUREMENTREQUISITIONEMPBIDWAREHOUSEIDLIST);
    }

    public void setProcurementRequisitionEmPbidWarehouseIdList(List<Requisition> procurementRequisitionEmPbidWarehouseIdList) {
        set(PROPERTY_PROCUREMENTREQUISITIONEMPBIDWAREHOUSEIDLIST, procurementRequisitionEmPbidWarehouseIdList);
    }
