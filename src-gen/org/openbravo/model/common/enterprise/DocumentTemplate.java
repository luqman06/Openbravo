...
public class DocumentTemplate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PRNTPRINTSERVICECLASS = "prntPrintserviceclass";
    ...
    public String getPrntPrintserviceclass() {
        return (String) get(PROPERTY_PRNTPRINTSERVICECLASS);
    }

    public void setPrntPrintserviceclass(String prntPrintserviceclass) {
        set(PROPERTY_PRNTPRINTSERVICECLASS, prntPrintserviceclass);
    }
