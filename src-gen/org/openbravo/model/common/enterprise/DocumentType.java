...
public class DocumentType extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZDOCUMENTSEQUENCEFORCOMPLETE = "oEZDocumentSequenceForComplete";
    ...
    public static final String PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONEMOEZDOCTYPELIST = "materialMgmtInternalConsumptionEMOezDoctypeList";
    public static final String PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMOEZDOCTYPEIDLIST = "materialMgmtInternalMovementEMOezDoctypeIDList";
    ...
    public DocumentType() {
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONEMOEZDOCTYPELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMOEZDOCTYPEIDLIST, new ArrayList<Object>());
    ...
    public Sequence getOEZDocumentSequenceForComplete() {
        return (Sequence) get(PROPERTY_OEZDOCUMENTSEQUENCEFORCOMPLETE);
    }

    public void setOEZDocumentSequenceForComplete(Sequence oEZDocumentSequenceForComplete) {
        set(PROPERTY_OEZDOCUMENTSEQUENCEFORCOMPLETE, oEZDocumentSequenceForComplete);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<InternalConsumption> getMaterialMgmtInternalConsumptionEMOezDoctypeList() {
      return (List<InternalConsumption>) get(PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONEMOEZDOCTYPELIST);
    }

    public void setMaterialMgmtInternalConsumptionEMOezDoctypeList(List<InternalConsumption> materialMgmtInternalConsumptionEMOezDoctypeList) {
        set(PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONEMOEZDOCTYPELIST, materialMgmtInternalConsumptionEMOezDoctypeList);
    }

    @SuppressWarnings("unchecked")
    public List<InternalMovement> getMaterialMgmtInternalMovementEMOezDoctypeIDList() {
      return (List<InternalMovement>) get(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMOEZDOCTYPEIDLIST);
    }

    public void setMaterialMgmtInternalMovementEMOezDoctypeIDList(List<InternalMovement> materialMgmtInternalMovementEMOezDoctypeIDList) {
        set(PROPERTY_MATERIALMGMTINTERNALMOVEMENTEMOEZDOCTYPEIDLIST, materialMgmtInternalMovementEMOezDoctypeIDList);
    }
