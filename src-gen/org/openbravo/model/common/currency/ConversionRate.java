...
public class ConversionRate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_IDKMK = "idKmk";
    public static final String PROPERTY_IDTANGGALKMK = "idTanggalkmk";
    ...
    public String getIdKmk() {
        return (String) get(PROPERTY_IDKMK);
    }

    public void setIdKmk(String idKmk) {
        set(PROPERTY_IDKMK, idKmk);
    }

    public Date getIdTanggalkmk() {
        return (Date) get(PROPERTY_IDTANGGALKMK);
    }

    public void setIdTanggalkmk(Date idTanggalkmk) {
        set(PROPERTY_IDTANGGALKMK, idTanggalkmk);
    }
