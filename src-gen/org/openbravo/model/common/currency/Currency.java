...
public class Currency extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_TAXCONVERSIONRATELIST = "taxConversionRateList";
    public static final String PROPERTY_TAXCONVERSIONRATETOCURRENCYLIST = "taxConversionRateToCurrencyList";
    ...
    public static final String PROPERTY_ORGANIZATIONEMOEZCASHCURRENCYIDLIST = "organizationEMOezCashCurrencyIDList";
    ...
    public static final String PROPERTY_PYRDEDUCTIONLIST = "pyrDeductionList";
    public static final String PROPERTY_PYREARNINGLIST = "pyrEarningList";
    public static final String PROPERTY_PYRSALARYPAYMENTLIST = "pyrSalarypaymentList";
    ...
    public Currency() {
        ...
        setDefaultValue(PROPERTY_TAXCONVERSIONRATELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_TAXCONVERSIONRATETOCURRENCYLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONEMOEZCASHCURRENCYIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_PYRDEDUCTIONLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PYREARNINGLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PYRSALARYPAYMENTLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<IDTaxConversionRate> getTaxConversionRateList() {
      return (List<IDTaxConversionRate>) get(PROPERTY_TAXCONVERSIONRATELIST);
    }

    public void setTaxConversionRateList(List<IDTaxConversionRate> taxConversionRateList) {
        set(PROPERTY_TAXCONVERSIONRATELIST, taxConversionRateList);
    }

    @SuppressWarnings("unchecked")
    public List<IDTaxConversionRate> getTaxConversionRateToCurrencyList() {
      return (List<IDTaxConversionRate>) get(PROPERTY_TAXCONVERSIONRATETOCURRENCYLIST);
    }

    public void setTaxConversionRateToCurrencyList(List<IDTaxConversionRate> taxConversionRateToCurrencyList) {
        set(PROPERTY_TAXCONVERSIONRATETOCURRENCYLIST, taxConversionRateToCurrencyList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMOezCashCurrencyIDList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOEZCASHCURRENCYIDLIST);
    }

    public void setOrganizationEMOezCashCurrencyIDList(List<Organization> organizationEMOezCashCurrencyIDList) {
        set(PROPERTY_ORGANIZATIONEMOEZCASHCURRENCYIDLIST, organizationEMOezCashCurrencyIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<pyr_deduction> getPyrDeductionList() {
      return (List<pyr_deduction>) get(PROPERTY_PYRDEDUCTIONLIST);
    }

    public void setPyrDeductionList(List<pyr_deduction> pyrDeductionList) {
        set(PROPERTY_PYRDEDUCTIONLIST, pyrDeductionList);
    }

    @SuppressWarnings("unchecked")
    public List<pyr_earning> getPyrEarningList() {
      return (List<pyr_earning>) get(PROPERTY_PYREARNINGLIST);
    }

    public void setPyrEarningList(List<pyr_earning> pyrEarningList) {
        set(PROPERTY_PYREARNINGLIST, pyrEarningList);
    }

    @SuppressWarnings("unchecked")
    public List<pyr_salarypayment> getPyrSalarypaymentList() {
      return (List<pyr_salarypayment>) get(PROPERTY_PYRSALARYPAYMENTLIST);
    }

    public void setPyrSalarypaymentList(List<pyr_salarypayment> pyrSalarypaymentList) {
        set(PROPERTY_PYRSALARYPAYMENTLIST, pyrSalarypaymentList);
    }
