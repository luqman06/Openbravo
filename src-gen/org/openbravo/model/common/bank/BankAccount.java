...
public class BankAccount extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.financialmgmt.cashmgmt.BankStatement> getFinancialMgmtBankStatementList() {
      return (List<org.openbravo.model.financialmgmt.cashmgmt.BankStatement>) get(PROPERTY_FINANCIALMGMTBANKSTATEMENTLIST);
    }

    public void setFinancialMgmtBankStatementList(List<org.openbravo.model.financialmgmt.cashmgmt.BankStatement> financialMgmtBankStatementList) {
