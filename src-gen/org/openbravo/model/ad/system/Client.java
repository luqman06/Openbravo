...
public class Client extends BaseOBObject implements Traceable, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZALLOWAUTOAPPROVEORDER = "oezAllowautoapproveorder";
    public static final String PROPERTY_OEZFORCEDOCUMENTROUTING = "oezForcedocumentrouting";
    ...
    public static final String PROPERTY_SETLEAVELIST = "setLeaveList";
    ...
    public Client() {
        ...
        setDefaultValue(PROPERTY_OEZALLOWAUTOAPPROVEORDER, false);
        ...
        setDefaultValue(PROPERTY_SETLEAVELIST, new ArrayList<Object>());
    }
    ...
    public Boolean isOezAllowautoapproveorder() {
        return (Boolean) get(PROPERTY_OEZALLOWAUTOAPPROVEORDER);
    }

    public void setOezAllowautoapproveorder(Boolean oezAllowautoapproveorder) {
        set(PROPERTY_OEZALLOWAUTOAPPROVEORDER, oezAllowautoapproveorder);
    }

    public String getOezForcedocumentrouting() {
        return (String) get(PROPERTY_OEZFORCEDOCUMENTROUTING);
    }

    public void setOezForcedocumentrouting(String oezForcedocumentrouting) {
        set(PROPERTY_OEZFORCEDOCUMENTROUTING, oezForcedocumentrouting);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<lv_set_leave> getSetLeaveList() {
      return (List<lv_set_leave>) get(PROPERTY_SETLEAVELIST);
    }

    public void setSetLeaveList(List<lv_set_leave> setLeaveList) {
        set(PROPERTY_SETLEAVELIST, setLeaveList);
    }
