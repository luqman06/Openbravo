...
public class ClientInformation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_HRISTREEDEPARTMENT = "hrisTreeDepartment";
    public static final String PROPERTY_PRIMARYTREEASSET = "primaryTreeAsset";
    public static final String PROPERTY_HRISTREEJOBTITLE = "hrisTreeJobtitle";
    public static final String PROPERTY_PRIMARYTREEPRODUCTCATEGORY = "primaryTreeProductCategory";
    public static final String PROPERTY_PYRTAXFORPAYROLL = "pyrTaxforpayroll";
    ...
    public static final String PROPERTY_PYRPAYMENTTERMFORPAYROLL = "pyrPaymenttermforpayroll";
    ...
    public Tree getHrisTreeDepartment() {
        return (Tree) get(PROPERTY_HRISTREEDEPARTMENT);
    }

    public void setHrisTreeDepartment(Tree hrisTreeDepartment) {
        set(PROPERTY_HRISTREEDEPARTMENT, hrisTreeDepartment);
    }
    ...
    public Tree getHrisTreeJobtitle() {
        return (Tree) get(PROPERTY_HRISTREEJOBTITLE);
    }

    public void setHrisTreeJobtitle(Tree hrisTreeJobtitle) {
        set(PROPERTY_HRISTREEJOBTITLE, hrisTreeJobtitle);
    }
    ...
    public TaxRate getPyrTaxforpayroll() {
        return (TaxRate) get(PROPERTY_PYRTAXFORPAYROLL);
    }

    public void setPyrTaxforpayroll(TaxRate pyrTaxforpayroll) {
        set(PROPERTY_PYRTAXFORPAYROLL, pyrTaxforpayroll);
    }
    ...
    public PaymentTerm getPyrPaymenttermforpayroll() {
        return (PaymentTerm) get(PROPERTY_PYRPAYMENTTERMFORPAYROLL);
    }

    public void setPyrPaymenttermforpayroll(PaymentTerm pyrPaymenttermforpayroll) {
        set(PROPERTY_PYRPAYMENTTERMFORPAYROLL, pyrPaymenttermforpayroll);
    }
