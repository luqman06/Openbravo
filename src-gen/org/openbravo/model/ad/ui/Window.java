...
public class Window extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBUIAPPPOOLREPORTLIST = "oBUIAPPPoolReportList";
    ...
    public static final String PROPERTY_OEZDOCUMENTROUTINGACTIONLIST = "oezDocumentroutingactionList";
    ...
    public Window() {
        ...
        setDefaultValue(PROPERTY_OBUIAPPPOOLREPORTLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OEZDOCUMENTROUTINGACTIONLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<DataPoolReport> getOBUIAPPPoolReportList() {
      return (List<DataPoolReport>) get(PROPERTY_OBUIAPPPOOLREPORTLIST);
    }

    public void setOBUIAPPPoolReportList(List<DataPoolReport> oBUIAPPPoolReportList) {
        set(PROPERTY_OBUIAPPPOOLREPORTLIST, oBUIAPPPoolReportList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_documentroutingaction> getOezDocumentroutingactionList() {
      return (List<oez_documentroutingaction>) get(PROPERTY_OEZDOCUMENTROUTINGACTIONLIST);
    }

    public void setOezDocumentroutingactionList(List<oez_documentroutingaction> oezDocumentroutingactionList) {
        set(PROPERTY_OEZDOCUMENTROUTINGACTIONLIST, oezDocumentroutingactionList);
    }
