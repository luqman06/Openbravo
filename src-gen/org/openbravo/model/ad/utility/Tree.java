...
public class Tree extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_CHARACTERISTICLIST = "characteristicList";
    ...
    public static final String PROPERTY_CLIENTINFORMATIONEMHRISTREEDEPARTMENTLIST = "clientInformationEmHrisTreeDepartmentList";
    public static final String PROPERTY_CLIENTINFORMATIONPRIMARYTREEASSETLIST = "clientInformationPrimaryTreeAssetList";
    public static final String PROPERTY_CLIENTINFORMATIONEMHRISTREEJOBTITLELIST = "clientInformationEMHrisTreeJobtitleList";
    ...
    public Tree() {
        ...
        setDefaultValue(PROPERTY_CHARACTERISTICLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_CLIENTINFORMATIONEMHRISTREEDEPARTMENTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_CLIENTINFORMATIONPRIMARYTREEASSETLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_CLIENTINFORMATIONEMHRISTREEJOBTITLELIST, new ArrayList<Object>());
    ...
    public List<Characteristic> getCharacteristicList() {
      return (List<Characteristic>) get(PROPERTY_CHARACTERISTICLIST);
    }

    public void setCharacteristicList(List<Characteristic> characteristicList) {
        set(PROPERTY_CHARACTERISTICLIST, characteristicList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ClientInformation> getClientInformationEmHrisTreeDepartmentList() {
      return (List<ClientInformation>) get(PROPERTY_CLIENTINFORMATIONEMHRISTREEDEPARTMENTLIST);
    }

    public void setClientInformationEmHrisTreeDepartmentList(List<ClientInformation> clientInformationEmHrisTreeDepartmentList) {
        set(PROPERTY_CLIENTINFORMATIONEMHRISTREEDEPARTMENTLIST, clientInformationEmHrisTreeDepartmentList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ClientInformation> getClientInformationEMHrisTreeJobtitleList() {
      return (List<ClientInformation>) get(PROPERTY_CLIENTINFORMATIONEMHRISTREEJOBTITLELIST);
    }

    public void setClientInformationEMHrisTreeJobtitleList(List<ClientInformation> clientInformationEMHrisTreeJobtitleList) {
        set(PROPERTY_CLIENTINFORMATIONEMHRISTREEJOBTITLELIST, clientInformationEMHrisTreeJobtitleList);
    }
