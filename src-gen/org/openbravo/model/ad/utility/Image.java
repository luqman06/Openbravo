...
public class Image extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ADUSEREMLVSIGNATURELIST = "aDUserEMLVSignatureList";
    public static final String PROPERTY_ADWINDOWLIST = "aDWindowList";
    public static final String PROPERTY_BUSINESSPARTNEREMHRISEMPLOYEEPICLIST = "businessPartnerEmHrisEmployeepicList";
    ...
    public Image() {
        ...
        setDefaultValue(PROPERTY_ADUSEREMLVSIGNATURELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ADWINDOWLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMHRISEMPLOYEEPICLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<User> getADUserEMLVSignatureList() {
      return (List<User>) get(PROPERTY_ADUSEREMLVSIGNATURELIST);
    }

    public void setADUserEMLVSignatureList(List<User> aDUserEMLVSignatureList) {
        set(PROPERTY_ADUSEREMLVSIGNATURELIST, aDUserEMLVSignatureList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEmHrisEmployeepicList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMHRISEMPLOYEEPICLIST);
    }

    public void setBusinessPartnerEmHrisEmployeepicList(List<BusinessPartner> businessPartnerEmHrisEmployeepicList) {
        set(PROPERTY_BUSINESSPARTNEREMHRISEMPLOYEEPICLIST, businessPartnerEmHrisEmployeepicList);
    }
