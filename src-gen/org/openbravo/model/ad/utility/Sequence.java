...
public class Sequence extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZCURRENTYEAR = "oezCurrentyear";
    public static final String PROPERTY_OEZRESETDOCSEQUENCE = "oezResetdocsequence";
    public static final String PROPERTY_OEZDOCSEQ = "oezDocseq";
    public static final String PROPERTY_OEZRESETTYPE = "oezResettype";
    public static final String PROPERTY_OEZGENERATEMONTH = "oezGenerateMonth";
    public static final String PROPERTY_DOCUMENTTYPEDOCUMENTSEQUENCELIST = "documentTypeDocumentSequenceList";
    public static final String PROPERTY_DOCUMENTTYPEEMOEZDOCUMENTSEQUENCEFORCOMPLETELIST = "documentTypeEMOEZDocumentSequenceForCompleteList";
    ...
    public Sequence() {
        ...
        setDefaultValue(PROPERTY_OEZRESETDOCSEQUENCE, false);
        setDefaultValue(PROPERTY_OEZDOCSEQ, false);
        setDefaultValue(PROPERTY_OEZGENERATEMONTH, false);
        setDefaultValue(PROPERTY_DOCUMENTTYPEDOCUMENTSEQUENCELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_DOCUMENTTYPEEMOEZDOCUMENTSEQUENCEFORCOMPLETELIST, new ArrayList<Object>());
    ...
    public Year getOezCurrentyear() {
        return (Year) get(PROPERTY_OEZCURRENTYEAR);
    }

    public void setOezCurrentyear(Year oezCurrentyear) {
        set(PROPERTY_OEZCURRENTYEAR, oezCurrentyear);
    }

    public Boolean isOezResetdocsequence() {
        return (Boolean) get(PROPERTY_OEZRESETDOCSEQUENCE);
    }

    public void setOezResetdocsequence(Boolean oezResetdocsequence) {
        set(PROPERTY_OEZRESETDOCSEQUENCE, oezResetdocsequence);
    }

    public Boolean isOezDocseq() {
        return (Boolean) get(PROPERTY_OEZDOCSEQ);
    }

    public void setOezDocseq(Boolean oezDocseq) {
        set(PROPERTY_OEZDOCSEQ, oezDocseq);
    }

    public String getOezResettype() {
        return (String) get(PROPERTY_OEZRESETTYPE);
    }

    public void setOezResettype(String oezResettype) {
        set(PROPERTY_OEZRESETTYPE, oezResettype);
    }

    public Boolean isOezGenerateMonth() {
        return (Boolean) get(PROPERTY_OEZGENERATEMONTH);
    }

    public void setOezGenerateMonth(Boolean oezGenerateMonth) {
        set(PROPERTY_OEZGENERATEMONTH, oezGenerateMonth);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<DocumentType> getDocumentTypeEMOEZDocumentSequenceForCompleteList() {
      return (List<DocumentType>) get(PROPERTY_DOCUMENTTYPEEMOEZDOCUMENTSEQUENCEFORCOMPLETELIST);
    }

    public void setDocumentTypeEMOEZDocumentSequenceForCompleteList(List<DocumentType> documentTypeEMOEZDocumentSequenceForCompleteList) {
        set(PROPERTY_DOCUMENTTYPEEMOEZDOCUMENTSEQUENCEFORCOMPLETELIST, documentTypeEMOEZDocumentSequenceForCompleteList);
    }
