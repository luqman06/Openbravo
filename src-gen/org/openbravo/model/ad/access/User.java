...
import org.wirabumi.mobileinfra.PendingApprove;
...
public class User extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_HRISISFAMILY = "hrisIsfamily";
    public static final String PROPERTY_IMAGE = "image";
    public static final String PROPERTY_HRISISTERTANGGUNG = "hrisIstertanggung";
    public static final String PROPERTY_GRANTPORTALACCESS = "grantPortalAccess";
    public static final String PROPERTY_HRISRELATION = "hrisRelation";
    ...
    public static final String PROPERTY_LVSIGNATURE = "lVSignature";
    ...
    public static final String PROPERTY_DATAIMPORTINVOICESALESREPRESENTATIVELIST = "dataImportInvoiceSalesRepresentativeList";
    public static final String PROPERTY_DATAIMPORTINVOICELIST = "dataImportInvoiceList";
    public static final String PROPERTY_DATAIMPORTORDERSALESREPRESENTATIVELIST = "dataImportOrderSalesRepresentativeList";
    ...
    public static final String PROPERTY_ORGANIZATIONINFORMATIONEMIDPKPIDLIST = "organizationInformationEMIdPkpIDList";
    ...
    public static final String PROPERTY_WAPIPENDINGAPPROVELIST = "wapiPendingapproveList";
    public static final String PROPERTY_WAPIPENDINGNOTIFLIST = "wapiPendingnotifList";

    public User() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_PROCESSNOW, false);
        setDefaultValue(PROPERTY_LOCKED, false);
        setDefaultValue(PROPERTY_HRISISFAMILY, true);
        setDefaultValue(PROPERTY_HRISISTERTANGGUNG, true);
        ...
        setDefaultValue(PROPERTY_DATAIMPORTINVOICESALESREPRESENTATIVELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_DATAIMPORTINVOICELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_DATAIMPORTORDERSALESREPRESENTATIVELIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONINFORMATIONEMIDPKPIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_WAPIPENDINGAPPROVELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_WAPIPENDINGNOTIFLIST, new ArrayList<Object>());
    }
    ...
    public Boolean isHrisIsfamily() {
        return (Boolean) get(PROPERTY_HRISISFAMILY);
    }

    public void setHrisIsfamily(Boolean hrisIsfamily) {
        set(PROPERTY_HRISISFAMILY, hrisIsfamily);
    }
    ...
    public Boolean isHrisIstertanggung() {
        return (Boolean) get(PROPERTY_HRISISTERTANGGUNG);
    }

    public void setHrisIstertanggung(Boolean hrisIstertanggung) {
        set(PROPERTY_HRISISTERTANGGUNG, hrisIstertanggung);
    }
    ...
    public String getHrisRelation() {
        return (String) get(PROPERTY_HRISRELATION);
    }

    public void setHrisRelation(String hrisRelation) {
        set(PROPERTY_HRISRELATION, hrisRelation);
    }
    ...
    public Image getLVSignature() {
        return (Image) get(PROPERTY_LVSIGNATURE);
    }

    public void setLVSignature(Image lVSignature) {
        set(PROPERTY_LVSIGNATURE, lVSignature);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Invoice> getDataImportInvoiceSalesRepresentativeList() {
      return (List<Invoice>) get(PROPERTY_DATAIMPORTINVOICESALESREPRESENTATIVELIST);
    }

    public void setDataImportInvoiceSalesRepresentativeList(List<Invoice> dataImportInvoiceSalesRepresentativeList) {
        set(PROPERTY_DATAIMPORTINVOICESALESREPRESENTATIVELIST, dataImportInvoiceSalesRepresentativeList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Order> getDataImportOrderSalesRepresentativeList() {
      return (List<Order>) get(PROPERTY_DATAIMPORTORDERSALESREPRESENTATIVELIST);
    }

    public void setDataImportOrderSalesRepresentativeList(List<Order> dataImportOrderSalesRepresentativeList) {
        set(PROPERTY_DATAIMPORTORDERSALESREPRESENTATIVELIST, dataImportOrderSalesRepresentativeList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.invoice.Invoice> getInvoiceSalesRepresentativeList() {
      return (List<org.openbravo.model.common.invoice.Invoice>) get(PROPERTY_INVOICESALESREPRESENTATIVELIST);
    }

    public void setInvoiceSalesRepresentativeList(List<org.openbravo.model.common.invoice.Invoice> invoiceSalesRepresentativeList) {
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.order.Order> getOrderSalesRepresentativeList() {
      return (List<org.openbravo.model.common.order.Order>) get(PROPERTY_ORDERSALESREPRESENTATIVELIST);
    }

    public void setOrderSalesRepresentativeList(List<org.openbravo.model.common.order.Order> orderSalesRepresentativeList) {
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.common.order.Order> getOrderDropShipContactList() {
      return (List<org.openbravo.model.common.order.Order>) get(PROPERTY_ORDERDROPSHIPCONTACTLIST);
    }

    public void setOrderDropShipContactList(List<org.openbravo.model.common.order.Order> orderDropShipContactList) {
    ...
    @SuppressWarnings("unchecked")
    public List<OrganizationInformation> getOrganizationInformationEMIdPkpIDList() {
      return (List<OrganizationInformation>) get(PROPERTY_ORGANIZATIONINFORMATIONEMIDPKPIDLIST);
    }

    public void setOrganizationInformationEMIdPkpIDList(List<OrganizationInformation> organizationInformationEMIdPkpIDList) {
        set(PROPERTY_ORGANIZATIONINFORMATIONEMIDPKPIDLIST, organizationInformationEMIdPkpIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<PendingApprove> getWapiPendingapproveList() {
      return (List<PendingApprove>) get(PROPERTY_WAPIPENDINGAPPROVELIST);
    }

    public void setWapiPendingapproveList(List<PendingApprove> wapiPendingapproveList) {
        set(PROPERTY_WAPIPENDINGAPPROVELIST, wapiPendingapproveList);
    }

    @SuppressWarnings("unchecked")
    public List<PendingNotification> getWapiPendingnotifList() {
      return (List<PendingNotification>) get(PROPERTY_WAPIPENDINGNOTIFLIST);
    }

    public void setWapiPendingnotifList(List<PendingNotification> wapiPendingnotifList) {
        set(PROPERTY_WAPIPENDINGNOTIFLIST, wapiPendingnotifList);
    }
