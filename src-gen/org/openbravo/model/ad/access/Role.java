...
public class Role extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBGPSCRCOPYROLE = "obgpscrCopyrole";
    ...
    public static final String PROPERTY_OEZEXCEEDCREDITLIMIT = "oezExceedCreditLimit";
    ...
    public static final String PROPERTY_HRISJOBTITLEROLELIST = "hrisJobtitleRoleList";
    ...
    public static final String PROPERTY_OEZDOCUMENTROUTINGLIST = "oezDocumentroutingList";
    ...
    public Role() {
        ...
        setDefaultValue(PROPERTY_OBGPSCRCOPYROLE, false);
        ...
        setDefaultValue(PROPERTY_OEZEXCEEDCREDITLIMIT, false);
        ...
        setDefaultValue(PROPERTY_HRISJOBTITLEROLELIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OEZDOCUMENTROUTINGLIST, new ArrayList<Object>());
    }
    ...
    public Boolean isObgpscrCopyrole() {
        return (Boolean) get(PROPERTY_OBGPSCRCOPYROLE);
    }

    public void setObgpscrCopyrole(Boolean obgpscrCopyrole) {
        set(PROPERTY_OBGPSCRCOPYROLE, obgpscrCopyrole);
    }
    ...
    public Boolean isOezExceedCreditLimit() {
        return (Boolean) get(PROPERTY_OEZEXCEEDCREDITLIMIT);
    }

    public void setOezExceedCreditLimit(Boolean oezExceedCreditLimit) {
        set(PROPERTY_OEZEXCEEDCREDITLIMIT, oezExceedCreditLimit);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<hris_jobtitle> getHrisJobtitleRoleList() {
      return (List<hris_jobtitle>) get(PROPERTY_HRISJOBTITLEROLELIST);
    }

    public void setHrisJobtitleRoleList(List<hris_jobtitle> hrisJobtitleRoleList) {
        set(PROPERTY_HRISJOBTITLEROLELIST, hrisJobtitleRoleList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_documentrouting> getOezDocumentroutingList() {
      return (List<oez_documentrouting>) get(PROPERTY_OEZDOCUMENTROUTINGLIST);
    }

    public void setOezDocumentroutingList(List<oez_documentrouting> oezDocumentroutingList) {
        set(PROPERTY_OEZDOCUMENTROUTINGLIST, oezDocumentroutingList);
    }
