...
public class Module extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OBGPSTMCREATETRLMODULE = "obgpstmCreateTrlModule";
    public static final String PROPERTY_OBGPSTMIMPORTTRL = "obgpstmImportTrl";
    public static final String PROPERTY_ENABLED = "enabled";
    public static final String PROPERTY_APPLYCONFIGURATIONSCRIPT = "applyConfigurationScript";
    public static final String PROPERTY_OBGPSTMEXPORTTRL = "obgpstmExportTrl";
    public static final String PROPERTY_UPGRADEAVAILABLE = "upgradeAvailable";
    public static final String PROPERTY_MPACKPACKAGEMODULE = "mPACKPackageModule";
    ...
    public Module() {
        ...
        setDefaultValue(PROPERTY_OBGPSTMCREATETRLMODULE, false);
        setDefaultValue(PROPERTY_OBGPSTMIMPORTTRL, false);
        setDefaultValue(PROPERTY_ENABLED, true);
        setDefaultValue(PROPERTY_APPLYCONFIGURATIONSCRIPT, true);
        setDefaultValue(PROPERTY_OBGPSTMEXPORTTRL, false);
        setDefaultValue(PROPERTY_MPACKPACKAGEMODULE, false);
    ...
    public Boolean isObgpstmCreateTrlModule() {
        return (Boolean) get(PROPERTY_OBGPSTMCREATETRLMODULE);
    }

    public void setObgpstmCreateTrlModule(Boolean obgpstmCreateTrlModule) {
        set(PROPERTY_OBGPSTMCREATETRLMODULE, obgpstmCreateTrlModule);
    }

    public Boolean isObgpstmImportTrl() {
        return (Boolean) get(PROPERTY_OBGPSTMIMPORTTRL);
    }

    public void setObgpstmImportTrl(Boolean obgpstmImportTrl) {
        set(PROPERTY_OBGPSTMIMPORTTRL, obgpstmImportTrl);
    }
    ...
    public Boolean isObgpstmExportTrl() {
        return (Boolean) get(PROPERTY_OBGPSTMEXPORTTRL);
    }

    public void setObgpstmExportTrl(Boolean obgpstmExportTrl) {
        set(PROPERTY_OBGPSTMEXPORTTRL, obgpstmExportTrl);
    }
    ...
    public Boolean isMPACKPackageModule() {
        return (Boolean) get(PROPERTY_MPACKPACKAGEMODULE);
    }

    public void setMPACKPackageModule(Boolean mPACKPackageModule) {
        set(PROPERTY_MPACKPACKAGEMODULE, mPACKPackageModule);
    }
