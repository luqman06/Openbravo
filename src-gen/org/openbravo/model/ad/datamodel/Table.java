...
import org.openbravo.model.dataimport.ImportFormat;
...
import org.wirabumi.gen.oez.oez_importcolumn;
import org.wirabumi.gen.oez.oez_importtable;
...
public class Table extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZHANDLERCLASSNAME = "oezHandlerclassname";
    public static final String PROPERTY_OEZDOCUMENTDATE = "oezDocumentdate";
    public static final String PROPERTY_OEZCODOCUMENTNO = "oezCodocumentno";
    public static final String PROPERTY_OEZDOCSTATUSCOLUMN = "oezDocstatuscolumn";
    public static final String PROPERTY_OEZTRXAMTCOLUMN = "oezTrxamtcolumn";
    public static final String PROPERTY_OEZTRXDATECOLUMN = "oezTrxdatecolumn";
    public static final String PROPERTY_SRISINVENTORY = "srIsinventory";
    ...
    public static final String PROPERTY_OEZIMPORTCOLUMNDESTINATIONTABLELIST = "oezImportcolumnDestinationTableList";
    public static final String PROPERTY_OEZIMPORTTABLESOURCETABLELIST = "oezImporttableSourceTableList";
    ...
    public Table() {
        ...
        setDefaultValue(PROPERTY_SRISINVENTORY, false);
        ...
        setDefaultValue(PROPERTY_OEZIMPORTCOLUMNDESTINATIONTABLELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZIMPORTTABLESOURCETABLELIST, new ArrayList<Object>());
    ...
    public String getOezHandlerclassname() {
        return (String) get(PROPERTY_OEZHANDLERCLASSNAME);
    }

    public void setOezHandlerclassname(String oezHandlerclassname) {
        set(PROPERTY_OEZHANDLERCLASSNAME, oezHandlerclassname);
    }

    public String getOezDocumentdate() {
        return (String) get(PROPERTY_OEZDOCUMENTDATE);
    }

    public void setOezDocumentdate(String oezDocumentdate) {
        set(PROPERTY_OEZDOCUMENTDATE, oezDocumentdate);
    }
    ...
    public String getOezDocstatuscolumn() {
        return (String) get(PROPERTY_OEZDOCSTATUSCOLUMN);
    }

    public void setOezDocstatuscolumn(String oezDocstatuscolumn) {
        set(PROPERTY_OEZDOCSTATUSCOLUMN, oezDocstatuscolumn);
    }

    public String getOezTrxamtcolumn() {
        return (String) get(PROPERTY_OEZTRXAMTCOLUMN);
    }

    public void setOezTrxamtcolumn(String oezTrxamtcolumn) {
        set(PROPERTY_OEZTRXAMTCOLUMN, oezTrxamtcolumn);
    }

    public String getOezTrxdatecolumn() {
        return (String) get(PROPERTY_OEZTRXDATECOLUMN);
    }

    public void setOezTrxdatecolumn(String oezTrxdatecolumn) {
        set(PROPERTY_OEZTRXDATECOLUMN, oezTrxdatecolumn);
    }

    public Boolean isSrIsinventory() {
        return (Boolean) get(PROPERTY_SRISINVENTORY);
    }

    public void setSrIsinventory(Boolean srIsinventory) {
        set(PROPERTY_SRISINVENTORY, srIsinventory);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ImportFormat> getDataImportFormatList() {
      return (List<ImportFormat>) get(PROPERTY_DATAIMPORTFORMATLIST);
    }

    public void setDataImportFormatList(List<ImportFormat> dataImportFormatList) {
        set(PROPERTY_DATAIMPORTFORMATLIST, dataImportFormatList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_importcolumn> getOezImportcolumnDestinationTableList() {
      return (List<oez_importcolumn>) get(PROPERTY_OEZIMPORTCOLUMNDESTINATIONTABLELIST);
    }

    public void setOezImportcolumnDestinationTableList(List<oez_importcolumn> oezImportcolumnDestinationTableList) {
        set(PROPERTY_OEZIMPORTCOLUMNDESTINATIONTABLELIST, oezImportcolumnDestinationTableList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_importtable> getOezImporttableSourceTableList() {
      return (List<oez_importtable>) get(PROPERTY_OEZIMPORTTABLESOURCETABLELIST);
    }

    public void setOezImporttableSourceTableList(List<oez_importtable> oezImporttableSourceTableList) {
        set(PROPERTY_OEZIMPORTTABLESOURCETABLELIST, oezImporttableSourceTableList);
    }
