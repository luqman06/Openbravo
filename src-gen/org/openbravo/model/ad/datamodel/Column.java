...
import org.openbravo.model.dataimport.ElementValue;
import org.openbravo.model.dataimport.ImportFormatRow;
...
public class Column extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_DATAIMPORTELEMENTVALUELIST = "dataImportElementValueList";
    public static final String PROPERTY_DATAIMPORTFORMATROWLIST = "dataImportFormatRowList";
    ...
    public static final String PROPERTY_OEZIMPORTCOLUMNSOURCECOLUMNLIST = "oezImportcolumnSourceColumnList";
    public static final String PROPERTY_OEZIMPORTCOLUMNDESTINATIONCOLUMNLIST = "oezImportcolumnDestinationColumnList";
    public static final String PROPERTY_OEZIMPORTCOLUMNKEYLOOKUPLIST = "oezImportcolumnKeylookupList";
    ...
    public Column() {
        ...
        setDefaultValue(PROPERTY_DATAIMPORTELEMENTVALUELIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_DATAIMPORTFORMATROWLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_OEZIMPORTCOLUMNSOURCECOLUMNLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZIMPORTCOLUMNDESTINATIONCOLUMNLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZIMPORTCOLUMNKEYLOOKUPLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ElementValue> getDataImportElementValueList() {
      return (List<ElementValue>) get(PROPERTY_DATAIMPORTELEMENTVALUELIST);
    }

    public void setDataImportElementValueList(List<ElementValue> dataImportElementValueList) {
        set(PROPERTY_DATAIMPORTELEMENTVALUELIST, dataImportElementValueList);
    }

    @SuppressWarnings("unchecked")
    public List<ImportFormatRow> getDataImportFormatRowList() {
      return (List<ImportFormatRow>) get(PROPERTY_DATAIMPORTFORMATROWLIST);
    }

    public void setDataImportFormatRowList(List<ImportFormatRow> dataImportFormatRowList) {
        set(PROPERTY_DATAIMPORTFORMATROWLIST, dataImportFormatRowList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_importcolumn> getOezImportcolumnSourceColumnList() {
      return (List<oez_importcolumn>) get(PROPERTY_OEZIMPORTCOLUMNSOURCECOLUMNLIST);
    }

    public void setOezImportcolumnSourceColumnList(List<oez_importcolumn> oezImportcolumnSourceColumnList) {
        set(PROPERTY_OEZIMPORTCOLUMNSOURCECOLUMNLIST, oezImportcolumnSourceColumnList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_importcolumn> getOezImportcolumnDestinationColumnList() {
      return (List<oez_importcolumn>) get(PROPERTY_OEZIMPORTCOLUMNDESTINATIONCOLUMNLIST);
    }

    public void setOezImportcolumnDestinationColumnList(List<oez_importcolumn> oezImportcolumnDestinationColumnList) {
        set(PROPERTY_OEZIMPORTCOLUMNDESTINATIONCOLUMNLIST, oezImportcolumnDestinationColumnList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_importcolumn> getOezImportcolumnKeylookupList() {
      return (List<oez_importcolumn>) get(PROPERTY_OEZIMPORTCOLUMNKEYLOOKUPLIST);
    }

    public void setOezImportcolumnKeylookupList(List<oez_importcolumn> oezImportcolumnKeylookupList) {
        set(PROPERTY_OEZIMPORTCOLUMNKEYLOOKUPLIST, oezImportcolumnKeylookupList);
    }
