...
public class ProjectPhase extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZDOCUMENTSTATUS = "oezDocumentstatus";
    ...
    public ProjectPhase() {
        ...
        setDefaultValue(PROPERTY_OEZDOCUMENTSTATUS, "DR");
    ...
    public String getOezDocumentstatus() {
        return (String) get(PROPERTY_OEZDOCUMENTSTATUS);
    }

    public void setOezDocumentstatus(String oezDocumentstatus) {
        set(PROPERTY_OEZDOCUMENTSTATUS, oezDocumentstatus);
    }
