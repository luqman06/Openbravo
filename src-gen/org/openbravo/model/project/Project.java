...
public class Project extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PBIDORDER = "pbidOrder";
    ...
    public Order getPbidOrder() {
        return (Order) get(PROPERTY_PBIDORDER);
    }

    public void setPbidOrder(Order pbidOrder) {
        set(PROPERTY_PBIDORDER, pbidOrder);
    }
