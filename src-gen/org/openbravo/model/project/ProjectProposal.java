...
public class ProjectProposal extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PBIDREQUISITION = "pbidRequisition";
    public static final String PROPERTY_PBIDSCORE = "pbidScore";
    ...
    public Requisition getPbidRequisition() {
        return (Requisition) get(PROPERTY_PBIDREQUISITION);
    }

    public void setPbidRequisition(Requisition pbidRequisition) {
        set(PROPERTY_PBIDREQUISITION, pbidRequisition);
    }

    public BigDecimal getPbidScore() {
        return (BigDecimal) get(PROPERTY_PBIDSCORE);
    }

    public void setPbidScore(BigDecimal pbidScore) {
        set(PROPERTY_PBIDSCORE, pbidScore);
    }
