...
public class RequisitionLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZSALESORDERLINE = "oezSalesorderline";
    ...
    public static final String PROPERTY_ICSONHANDSTOCK = "icsOnhandStock";
    ...
    public static final String PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONLINEEMOEZREQUISITIONLINEIDLIST = "materialMgmtInternalConsumptionLineEMOezRequisitionlineIDList";
    public static final String PROPERTY_PROCUREMENTREQUISITIONPOMATCHLIST = "procurementRequisitionPOMatchList";
    public static final String PROPERTY_UNREALIZEDUSAGELIST = "unrealizedusageList";
    ...
    // nor OBCriteria. 
    public static final String COMPUTED_COLUMN_PBIDQTYDELIVERED = "pbidQtydelivered";
    public static final String COMPUTED_COLUMN_PBIDQTYORDERED = "pbidQtyordered";
    ...
    public RequisitionLine() {
        ...
        setDefaultValue(PROPERTY_ICSONHANDSTOCK, new BigDecimal(0));
        ...
        setDefaultValue(PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONLINEEMOEZREQUISITIONLINEIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONPOMATCHLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_UNREALIZEDUSAGELIST, new ArrayList<Object>());
    }
    ...
    public OrderLine getOezSalesorderline() {
        return (OrderLine) get(PROPERTY_OEZSALESORDERLINE);
    }

    public void setOezSalesorderline(OrderLine oezSalesorderline) {
        set(PROPERTY_OEZSALESORDERLINE, oezSalesorderline);
    }
    ...
    public BigDecimal getIcsOnhandStock() {
        return (BigDecimal) get(PROPERTY_ICSONHANDSTOCK);
    }

    public void setIcsOnhandStock(BigDecimal icsOnhandStock) {
        set(PROPERTY_ICSONHANDSTOCK, icsOnhandStock);
    }

    public BigDecimal getPbidQtydelivered() {
        return (BigDecimal) get(COMPUTED_COLUMN_PBIDQTYDELIVERED);
    }

    public void setPbidQtydelivered(BigDecimal pbidQtydelivered) {
        set(COMPUTED_COLUMN_PBIDQTYDELIVERED, pbidQtydelivered);
    }

    public BigDecimal getPbidQtyordered() {
        return (BigDecimal) get(COMPUTED_COLUMN_PBIDQTYORDERED);
    }

    public void setPbidQtyordered(BigDecimal pbidQtyordered) {
        set(COMPUTED_COLUMN_PBIDQTYORDERED, pbidQtyordered);
    }

    public RequisitionLine_ComputedColumns get_computedColumns() {
        return (RequisitionLine_ComputedColumns) get(PROPERTY__COMPUTEDCOLUMNS);
    }

    public void set_computedColumns(RequisitionLine_ComputedColumns _computedColumns) {
    ...
    @SuppressWarnings("unchecked")
    public List<InternalConsumptionLine> getMaterialMgmtInternalConsumptionLineEMOezRequisitionlineIDList() {
      return (List<InternalConsumptionLine>) get(PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONLINEEMOEZREQUISITIONLINEIDLIST);
    }

    public void setMaterialMgmtInternalConsumptionLineEMOezRequisitionlineIDList(List<InternalConsumptionLine> materialMgmtInternalConsumptionLineEMOezRequisitionlineIDList) {
        set(PROPERTY_MATERIALMGMTINTERNALCONSUMPTIONLINEEMOEZREQUISITIONLINEIDLIST, materialMgmtInternalConsumptionLineEMOezRequisitionlineIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<UnrealizedBudgetUsage> getUnrealizedusageList() {
      return (List<UnrealizedBudgetUsage>) get(PROPERTY_UNREALIZEDUSAGELIST);
    }

    public void setUnrealizedusageList(List<UnrealizedBudgetUsage> unrealizedusageList) {
        set(PROPERTY_UNREALIZEDUSAGELIST, unrealizedusageList);
    }


    @Override
    public Object get(String propName) {
      if (COMPUTED_COLUMN_PBIDQTYDELIVERED.equals(propName)) {
        if (get_computedColumns() == null) {
          return null;
        }
        return get_computedColumns().getPbidQtydelivered();
      }
      if (COMPUTED_COLUMN_PBIDQTYORDERED.equals(propName)) {
        if (get_computedColumns() == null) {
          return null;
        }
        return get_computedColumns().getPbidQtyordered();
      }
