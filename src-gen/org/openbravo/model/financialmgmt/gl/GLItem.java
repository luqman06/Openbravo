...
public class GLItem extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_PYRDEDUCTIONACCOUNTLIST = "pyrDeductionAccountList";
    public static final String PROPERTY_PYREARNINGACCOUNTLIST = "pyrEarningAccountList";
    ...
    public GLItem() {
        ...
        setDefaultValue(PROPERTY_PYRDEDUCTIONACCOUNTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PYREARNINGACCOUNTLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<pyr_deduction> getPyrDeductionAccountList() {
      return (List<pyr_deduction>) get(PROPERTY_PYRDEDUCTIONACCOUNTLIST);
    }

    public void setPyrDeductionAccountList(List<pyr_deduction> pyrDeductionAccountList) {
        set(PROPERTY_PYRDEDUCTIONACCOUNTLIST, pyrDeductionAccountList);
    }

    @SuppressWarnings("unchecked")
    public List<pyr_earning> getPyrEarningAccountList() {
      return (List<pyr_earning>) get(PROPERTY_PYREARNINGACCOUNTLIST);
    }

    public void setPyrEarningAccountList(List<pyr_earning> pyrEarningAccountList) {
        set(PROPERTY_PYREARNINGACCOUNTLIST, pyrEarningAccountList);
    }
