...
public class GLJournal extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.dataimport.GLJournal> getDataImportGLJournalList() {
      return (List<org.openbravo.model.dataimport.GLJournal>) get(PROPERTY_DATAIMPORTGLJOURNALLIST);
    }

    public void setDataImportGLJournalList(List<org.openbravo.model.dataimport.GLJournal> dataImportGLJournalList) {
