...
public class Costcenter extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_BUSINESSPARTNEREMHRISCCOSTCENTERIDLIST = "businessPartnerEMHrisCCostcenterIDList";
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETEMCAMCOSTCENTERIDLIST = "financialMgmtAssetEmCamCostcenterIdList";
    ...
    public static final String PROPERTY_PROCUREMENTREQUISITIONEMPBIDCOSTCENTERIDLIST = "procurementRequisitionEmPbidCostcenterIdList";
    public static final String PROPERTY_PROJECTEMPBIDCOSTCENTERIDLIST = "projectEmPbidCostcenterIdList";
    ...
    public static final String PROPERTY_CAMWORKORDERASSETOLDCOSTCENTERLIST = "camWorkorderassetOldCostCenterList";
    public static final String PROPERTY_HRISETLINEOLDCOSTCENTERIDLIST = "hrisEtLineOLDCostcenterIDList";
    public static final String PROPERTY_HRISETLINENEWCOSTCENTERIDLIST = "hrisEtLineNEWCostcenterIDList";
    public static final String PROPERTY_HRISJOBTITLECOSTCENTERLIST = "hrisJobtitleCostCenterList";
    ...
    public Costcenter() {
        ...
        setDefaultValue(PROPERTY_BUSINESSPARTNEREMHRISCCOSTCENTERIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETEMCAMCOSTCENTERIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_PROCUREMENTREQUISITIONEMPBIDCOSTCENTERIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_PROJECTEMPBIDCOSTCENTERIDLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_CAMWORKORDERASSETOLDCOSTCENTERLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_HRISETLINEOLDCOSTCENTERIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_HRISETLINENEWCOSTCENTERIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_HRISJOBTITLECOSTCENTERLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<BusinessPartner> getBusinessPartnerEMHrisCCostcenterIDList() {
      return (List<BusinessPartner>) get(PROPERTY_BUSINESSPARTNEREMHRISCCOSTCENTERIDLIST);
    }

    public void setBusinessPartnerEMHrisCCostcenterIDList(List<BusinessPartner> businessPartnerEMHrisCCostcenterIDList) {
        set(PROPERTY_BUSINESSPARTNEREMHRISCCOSTCENTERIDLIST, businessPartnerEMHrisCCostcenterIDList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Asset> getFinancialMgmtAssetEmCamCostcenterIdList() {
      return (List<Asset>) get(PROPERTY_FINANCIALMGMTASSETEMCAMCOSTCENTERIDLIST);
    }

    public void setFinancialMgmtAssetEmCamCostcenterIdList(List<Asset> financialMgmtAssetEmCamCostcenterIdList) {
        set(PROPERTY_FINANCIALMGMTASSETEMCAMCOSTCENTERIDLIST, financialMgmtAssetEmCamCostcenterIdList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Requisition> getProcurementRequisitionEmPbidCostcenterIdList() {
      return (List<Requisition>) get(PROPERTY_PROCUREMENTREQUISITIONEMPBIDCOSTCENTERIDLIST);
    }

    public void setProcurementRequisitionEmPbidCostcenterIdList(List<Requisition> procurementRequisitionEmPbidCostcenterIdList) {
        set(PROPERTY_PROCUREMENTREQUISITIONEMPBIDCOSTCENTERIDLIST, procurementRequisitionEmPbidCostcenterIdList);
    }

    @SuppressWarnings("unchecked")
    public List<Project> getProjectEmPbidCostcenterIdList() {
      return (List<Project>) get(PROPERTY_PROJECTEMPBIDCOSTCENTERIDLIST);
    }

    public void setProjectEmPbidCostcenterIdList(List<Project> projectEmPbidCostcenterIdList) {
        set(PROPERTY_PROJECTEMPBIDCOSTCENTERIDLIST, projectEmPbidCostcenterIdList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<WorkOrderAsset> getCamWorkorderassetOldCostCenterList() {
      return (List<WorkOrderAsset>) get(PROPERTY_CAMWORKORDERASSETOLDCOSTCENTERLIST);
    }

    public void setCamWorkorderassetOldCostCenterList(List<WorkOrderAsset> camWorkorderassetOldCostCenterList) {
        set(PROPERTY_CAMWORKORDERASSETOLDCOSTCENTERLIST, camWorkorderassetOldCostCenterList);
    }

    @SuppressWarnings("unchecked")
    public List<EmployeeTransferLine> getHrisEtLineOLDCostcenterIDList() {
      return (List<EmployeeTransferLine>) get(PROPERTY_HRISETLINEOLDCOSTCENTERIDLIST);
    }

    public void setHrisEtLineOLDCostcenterIDList(List<EmployeeTransferLine> hrisEtLineOLDCostcenterIDList) {
        set(PROPERTY_HRISETLINEOLDCOSTCENTERIDLIST, hrisEtLineOLDCostcenterIDList);
    }

    @SuppressWarnings("unchecked")
    public List<EmployeeTransferLine> getHrisEtLineNEWCostcenterIDList() {
      return (List<EmployeeTransferLine>) get(PROPERTY_HRISETLINENEWCOSTCENTERIDLIST);
    }

    public void setHrisEtLineNEWCostcenterIDList(List<EmployeeTransferLine> hrisEtLineNEWCostcenterIDList) {
        set(PROPERTY_HRISETLINENEWCOSTCENTERIDLIST, hrisEtLineNEWCostcenterIDList);
    }

    @SuppressWarnings("unchecked")
    public List<hris_jobtitle> getHrisJobtitleCostCenterList() {
      return (List<hris_jobtitle>) get(PROPERTY_HRISJOBTITLECOSTCENTERLIST);
    }

    public void setHrisJobtitleCostCenterList(List<hris_jobtitle> hrisJobtitleCostCenterList) {
        set(PROPERTY_HRISJOBTITLECOSTCENTERLIST, hrisJobtitleCostCenterList);
    }
