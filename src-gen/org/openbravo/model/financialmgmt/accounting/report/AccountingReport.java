...
public class AccountingReport extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZCASHFLOW = "oezCashflow";
    ...
    public AccountingReport() {
        ...
        setDefaultValue(PROPERTY_OEZCASHFLOW, false);
    ...
    public Boolean isOezCashflow() {
        return (Boolean) get(PROPERTY_OEZCASHFLOW);
    }

    public void setOezCashflow(Boolean oezCashflow) {
        set(PROPERTY_OEZCASHFLOW, oezCashflow);
    }
