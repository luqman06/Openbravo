...
public class BudgetLine extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_EBBUDGETBALANCE = "ebBudgetbalance";
    public static final String PROPERTY_EBREALIZEDUSAGE = "ebRealizedusage";
    public static final String PROPERTY_EBUNREALIZEDUSAGE = "ebUnrealizedusage";
    ...
    public BigDecimal getEbBudgetbalance() {
        return (BigDecimal) get(PROPERTY_EBBUDGETBALANCE);
    }

    public void setEbBudgetbalance(BigDecimal ebBudgetbalance) {
        set(PROPERTY_EBBUDGETBALANCE, ebBudgetbalance);
    }

    public BigDecimal getEbRealizedusage() {
        return (BigDecimal) get(PROPERTY_EBREALIZEDUSAGE);
    }

    public void setEbRealizedusage(BigDecimal ebRealizedusage) {
        set(PROPERTY_EBREALIZEDUSAGE, ebRealizedusage);
    }

    public BigDecimal getEbUnrealizedusage() {
        return (BigDecimal) get(PROPERTY_EBUNREALIZEDUSAGE);
    }

    public void setEbUnrealizedusage(BigDecimal ebUnrealizedusage) {
        set(PROPERTY_EBUNREALIZEDUSAGE, ebUnrealizedusage);
    }

    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.dataimport.BudgetLine> getDataImportBudgetLineList() {
      return (List<org.openbravo.model.dataimport.BudgetLine>) get(PROPERTY_DATAIMPORTBUDGETLINELIST);
    }

    public void setDataImportBudgetLineList(List<org.openbravo.model.dataimport.BudgetLine> dataImportBudgetLineList) {
