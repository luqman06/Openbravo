...
public class ElementValue extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_DATAIMPORTELEMENTVALUEPARENTACCOUNTLIST = "dataImportElementValueParentAccountList";
    public static final String PROPERTY_DATAIMPORTGLJOURNALACCOUNTLIST = "dataImportGLJournalAccountList";
    ...
    public ElementValue() {
        ...
        setDefaultValue(PROPERTY_DATAIMPORTELEMENTVALUEPARENTACCOUNTLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_DATAIMPORTGLJOURNALACCOUNTLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.dataimport.ElementValue> getDataImportElementValueList() {
      return (List<org.openbravo.model.dataimport.ElementValue>) get(PROPERTY_DATAIMPORTELEMENTVALUELIST);
    }

    public void setDataImportElementValueList(List<org.openbravo.model.dataimport.ElementValue> dataImportElementValueList) {
        set(PROPERTY_DATAIMPORTELEMENTVALUELIST, dataImportElementValueList);
    }

    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.dataimport.ElementValue> getDataImportElementValueParentAccountList() {
      return (List<org.openbravo.model.dataimport.ElementValue>) get(PROPERTY_DATAIMPORTELEMENTVALUEPARENTACCOUNTLIST);
    }

    public void setDataImportElementValueParentAccountList(List<org.openbravo.model.dataimport.ElementValue> dataImportElementValueParentAccountList) {
        set(PROPERTY_DATAIMPORTELEMENTVALUEPARENTACCOUNTLIST, dataImportElementValueParentAccountList);
    }

    @SuppressWarnings("unchecked")
    public List<GLJournal> getDataImportGLJournalAccountList() {
      return (List<GLJournal>) get(PROPERTY_DATAIMPORTGLJOURNALACCOUNTLIST);
    }

    public void setDataImportGLJournalAccountList(List<GLJournal> dataImportGLJournalAccountList) {
        set(PROPERTY_DATAIMPORTGLJOURNALACCOUNTLIST, dataImportGLJournalAccountList);
    }
