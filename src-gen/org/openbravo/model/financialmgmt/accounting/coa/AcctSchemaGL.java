...
public class AcctSchemaGL extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZREALIZEDARFOREX = "oezRealizedArForex";
    public static final String PROPERTY_OEZUNREALIZEDGAINFOREX = "oezUnrealizedgainforex";
    public static final String PROPERTY_OEZREALIZEDAPFOREX = "oezRealizedApForex";
    public static final String PROPERTY_OEZUNREALIZEDLOSSFOREX = "oezUnrealizedlossforex";
    public static final String PROPERTY_OEZPURCASEACCT = "oezPurcaseAcct";
    ...
    public AccountingCombination getOezRealizedArForex() {
        return (AccountingCombination) get(PROPERTY_OEZREALIZEDARFOREX);
    }

    public void setOezRealizedArForex(AccountingCombination oezRealizedArForex) {
        set(PROPERTY_OEZREALIZEDARFOREX, oezRealizedArForex);
    }

    public AccountingCombination getOezUnrealizedgainforex() {
        return (AccountingCombination) get(PROPERTY_OEZUNREALIZEDGAINFOREX);
    }

    public void setOezUnrealizedgainforex(AccountingCombination oezUnrealizedgainforex) {
        set(PROPERTY_OEZUNREALIZEDGAINFOREX, oezUnrealizedgainforex);
    }

    public AccountingCombination getOezRealizedApForex() {
        return (AccountingCombination) get(PROPERTY_OEZREALIZEDAPFOREX);
    }

    public void setOezRealizedApForex(AccountingCombination oezRealizedApForex) {
        set(PROPERTY_OEZREALIZEDAPFOREX, oezRealizedApForex);
    }

    public AccountingCombination getOezUnrealizedlossforex() {
        return (AccountingCombination) get(PROPERTY_OEZUNREALIZEDLOSSFOREX);
    }

    public void setOezUnrealizedlossforex(AccountingCombination oezUnrealizedlossforex) {
        set(PROPERTY_OEZUNREALIZEDLOSSFOREX, oezUnrealizedlossforex);
    }

    public AccountingCombination getOezPurcaseAcct() {
        return (AccountingCombination) get(PROPERTY_OEZPURCASEACCT);
    }

    public void setOezPurcaseAcct(AccountingCombination oezPurcaseAcct) {
        set(PROPERTY_OEZPURCASEACCT, oezPurcaseAcct);
    }
