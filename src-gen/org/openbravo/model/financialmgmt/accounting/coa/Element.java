...
public class Element extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    @SuppressWarnings("unchecked")
    public List<org.openbravo.model.financialmgmt.accounting.coa.ElementValue> getFinancialMgmtElementValueList() {
      return (List<org.openbravo.model.financialmgmt.accounting.coa.ElementValue>) get(PROPERTY_FINANCIALMGMTELEMENTVALUELIST);
    }

    public void setFinancialMgmtElementValueList(List<org.openbravo.model.financialmgmt.accounting.coa.ElementValue> financialMgmtElementValueList) {
