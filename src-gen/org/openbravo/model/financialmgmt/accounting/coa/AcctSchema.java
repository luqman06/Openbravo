...
public class AcctSchema extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ORGANIZATIONEMOEZACCTSCHEMALIST = "organizationEMOezAcctschemaList";
    public static final String PROPERTY_ORGANIZATIONEMOEZBSACCTSCHMEIDLIST = "organizationEMOezBsAcctschmeIDList";
    public static final String PROPERTY_ORGANIZATIONEMOEZISACCTSCHEMAIDLIST = "organizationEMOezIsAcctschemaIDList";
    ...
    public AcctSchema() {
        ...
        setDefaultValue(PROPERTY_ORGANIZATIONEMOEZACCTSCHEMALIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ORGANIZATIONEMOEZBSACCTSCHMEIDLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_ORGANIZATIONEMOEZISACCTSCHEMAIDLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMOezAcctschemaList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOEZACCTSCHEMALIST);
    }

    public void setOrganizationEMOezAcctschemaList(List<Organization> organizationEMOezAcctschemaList) {
        set(PROPERTY_ORGANIZATIONEMOEZACCTSCHEMALIST, organizationEMOezAcctschemaList);
    }

    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMOezBsAcctschmeIDList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOEZBSACCTSCHMEIDLIST);
    }

    public void setOrganizationEMOezBsAcctschmeIDList(List<Organization> organizationEMOezBsAcctschmeIDList) {
        set(PROPERTY_ORGANIZATIONEMOEZBSACCTSCHMEIDLIST, organizationEMOezBsAcctschmeIDList);
    }

    @SuppressWarnings("unchecked")
    public List<Organization> getOrganizationEMOezIsAcctschemaIDList() {
      return (List<Organization>) get(PROPERTY_ORGANIZATIONEMOEZISACCTSCHEMAIDLIST);
    }

    public void setOrganizationEMOezIsAcctschemaIDList(List<Organization> organizationEMOezIsAcctschemaIDList) {
        set(PROPERTY_ORGANIZATIONEMOEZISACCTSCHEMAIDLIST, organizationEMOezIsAcctschemaIDList);
    }
