...
public class Year extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_ADSEQUENCEEMOEZCURRENTYEARLIST = "aDSequenceEMOezCurrentyearList";
    ...
    public Year() {
        ...
        setDefaultValue(PROPERTY_ADSEQUENCEEMOEZCURRENTYEARLIST, new ArrayList<Object>());
    ...
    public List<Sequence> getADSequenceEMOezCurrentyearList() {
      return (List<Sequence>) get(PROPERTY_ADSEQUENCEEMOEZCURRENTYEARLIST);
    }

    public void setADSequenceEMOezCurrentyearList(List<Sequence> aDSequenceEMOezCurrentyearList) {
        set(PROPERTY_ADSEQUENCEEMOEZCURRENTYEARLIST, aDSequenceEMOezCurrentyearList);
    }
