...
public class AssetGroup extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_FINANCIALMGMTASSETGROUPEMCAMPARENTIDLIST = "financialMgmtAssetGroupEmCamParentIdList";
    ...
    public AssetGroup() {
        ...
        setDefaultValue(PROPERTY_FINANCIALMGMTASSETGROUPEMCAMPARENTIDLIST, new ArrayList<Object>());
    ...
    public AssetGroup getCamParent() {
        return (AssetGroup) get(PROPERTY_CAMPARENT);
    }

    public void setCamParent(AssetGroup camParent) {
    ...
    @SuppressWarnings("unchecked")
    public List<AssetGroup> getFinancialMgmtAssetGroupEmCamParentIdList() {
      return (List<AssetGroup>) get(PROPERTY_FINANCIALMGMTASSETGROUPEMCAMPARENTIDLIST);
    }

    public void setFinancialMgmtAssetGroupEmCamParentIdList(List<AssetGroup> financialMgmtAssetGroupEmCamParentIdList) {
        set(PROPERTY_FINANCIALMGMTASSETGROUPEMCAMPARENTIDLIST, financialMgmtAssetGroupEmCamParentIdList);
    }
