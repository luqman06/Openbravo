...
public class Amortization extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_CAMPROCESSING = "camProcessing";
    ...
    public String getCamProcessing() {
        return (String) get(PROPERTY_CAMPROCESSING);
    }

    public void setCamProcessing(String camProcessing) {
        set(PROPERTY_CAMPROCESSING, camProcessing);
    }
