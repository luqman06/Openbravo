...
public class TaxRate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_IDTAXCONVERSION = "idTaxconversion";
    public static final String PROPERTY_IDPPN = "idPpn";
    ...
    public static final String PROPERTY_CLIENTINFORMATIONEMPYRTAXFORPAYROLLLIST = "clientInformationEMPyrTaxforpayrollList";
    ...
    public static final String PROPERTY_DATAIMPORTTAXPARENTTAXRATELIST = "dataImportTaxParentTaxRateList";
    ...
    public TaxRate() {
        ...
        setDefaultValue(PROPERTY_IDTAXCONVERSION, false);
        setDefaultValue(PROPERTY_IDPPN, false);
        ...
        setDefaultValue(PROPERTY_CLIENTINFORMATIONEMPYRTAXFORPAYROLLLIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_DATAIMPORTTAXPARENTTAXRATELIST, new ArrayList<Object>());
    ...
    public Boolean isIdTaxconversion() {
        return (Boolean) get(PROPERTY_IDTAXCONVERSION);
    }

    public void setIdTaxconversion(Boolean idTaxconversion) {
        set(PROPERTY_IDTAXCONVERSION, idTaxconversion);
    }

    public Boolean isIdPpn() {
        return (Boolean) get(PROPERTY_IDPPN);
    }

    public void setIdPpn(Boolean idPpn) {
        set(PROPERTY_IDPPN, idPpn);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ClientInformation> getClientInformationEMPyrTaxforpayrollList() {
      return (List<ClientInformation>) get(PROPERTY_CLIENTINFORMATIONEMPYRTAXFORPAYROLLLIST);
    }

    public void setClientInformationEMPyrTaxforpayrollList(List<ClientInformation> clientInformationEMPyrTaxforpayrollList) {
        set(PROPERTY_CLIENTINFORMATIONEMPYRTAXFORPAYROLLLIST, clientInformationEMPyrTaxforpayrollList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<Tax> getDataImportTaxParentTaxRateList() {
      return (List<Tax>) get(PROPERTY_DATAIMPORTTAXPARENTTAXRATELIST);
    }

    public void setDataImportTaxParentTaxRateList(List<Tax> dataImportTaxParentTaxRateList) {
        set(PROPERTY_DATAIMPORTTAXPARENTTAXRATELIST, dataImportTaxParentTaxRateList);
    }
