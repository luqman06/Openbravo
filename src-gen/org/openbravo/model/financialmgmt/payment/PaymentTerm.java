...
public class PaymentTerm extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_CLIENTINFORMATIONEMPYRPAYMENTTERMFORPAYROLLLIST = "clientInformationEMPyrPaymenttermforpayrollList";
    ...
    public PaymentTerm() {
        ...
        setDefaultValue(PROPERTY_CLIENTINFORMATIONEMPYRPAYMENTTERMFORPAYROLLLIST, new ArrayList<Object>());
    ...
    @SuppressWarnings("unchecked")
    public List<ClientInformation> getClientInformationEMPyrPaymenttermforpayrollList() {
      return (List<ClientInformation>) get(PROPERTY_CLIENTINFORMATIONEMPYRPAYMENTTERMFORPAYROLLLIST);
    }

    public void setClientInformationEMPyrPaymenttermforpayrollList(List<ClientInformation> clientInformationEMPyrPaymenttermforpayrollList) {
        set(PROPERTY_CLIENTINFORMATIONEMPYRPAYMENTTERMFORPAYROLLLIST, clientInformationEMPyrPaymenttermforpayrollList);
    }
