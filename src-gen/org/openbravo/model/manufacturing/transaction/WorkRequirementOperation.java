...
import org.wirabumi.gen.oez.oez_production_run_v;
import org.wirabumi.gen.oez.oez_productionnew_v;
/**
...
public class WorkRequirementOperation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZPRODUCTIONRUNVLIST = "oezProductionRunVList";
    public static final String PROPERTY_OEZPRODUCTIONNEWVLIST = "oezProductionnewVList";
    ...
    public WorkRequirementOperation() {
        ...
        setDefaultValue(PROPERTY_OEZPRODUCTIONRUNVLIST, new ArrayList<Object>());
        setDefaultValue(PROPERTY_OEZPRODUCTIONNEWVLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_production_run_v> getOezProductionRunVList() {
      return (List<oez_production_run_v>) get(PROPERTY_OEZPRODUCTIONRUNVLIST);
    }

    public void setOezProductionRunVList(List<oez_production_run_v> oezProductionRunVList) {
        set(PROPERTY_OEZPRODUCTIONRUNVLIST, oezProductionRunVList);
    }

    @SuppressWarnings("unchecked")
    public List<oez_productionnew_v> getOezProductionnewVList() {
      return (List<oez_productionnew_v>) get(PROPERTY_OEZPRODUCTIONNEWVLIST);
    }

    public void setOezProductionnewVList(List<oez_productionnew_v> oezProductionnewVList) {
        set(PROPERTY_OEZPRODUCTIONNEWVLIST, oezProductionnewVList);
    }
