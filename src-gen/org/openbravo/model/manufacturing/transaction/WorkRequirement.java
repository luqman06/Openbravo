...
public class WorkRequirement extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZIWORKREQUIREMENTLIST = "oezIWorkrequirementList";
    ...
    public WorkRequirement() {
        ...
        setDefaultValue(PROPERTY_OEZIWORKREQUIREMENTLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<ImportWorkRequirement> getOezIWorkrequirementList() {
      return (List<ImportWorkRequirement>) get(PROPERTY_OEZIWORKREQUIREMENTLIST);
    }

    public void setOezIWorkrequirementList(List<ImportWorkRequirement> oezIWorkrequirementList) {
        set(PROPERTY_OEZIWORKREQUIREMENTLIST, oezIWorkrequirementList);
    }
