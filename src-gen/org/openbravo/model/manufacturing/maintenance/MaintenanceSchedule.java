...
public class MaintenanceSchedule extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_CAMALERTPERIOD = "camAlertperiod";
    public static final String PROPERTY_CAMASSET = "camAsset";
    public static final String PROPERTY_CAMFREQUENCY = "camFrequency";
    public static final String PROPERTY_CAMFREQUENCYAMT = "camFrequencyamt";
    public static final String PROPERTY_CAMNEXTDUE = "camNextdue";
    public static final String PROPERTY_CAMSTARTDATE = "camStartdate";
    ...
    public MaintenanceSchedule() {
        ...
        setDefaultValue(PROPERTY_CAMFREQUENCYAMT, (long) 1);
    ...
    public Long getCamAlertperiod() {
        return (Long) get(PROPERTY_CAMALERTPERIOD);
    }

    public void setCamAlertperiod(Long camAlertperiod) {
        set(PROPERTY_CAMALERTPERIOD, camAlertperiod);
    }

    public Asset getCamAsset() {
        return (Asset) get(PROPERTY_CAMASSET);
    }

    public void setCamAsset(Asset camAsset) {
        set(PROPERTY_CAMASSET, camAsset);
    }

    public String getCamFrequency() {
        return (String) get(PROPERTY_CAMFREQUENCY);
    }

    public void setCamFrequency(String camFrequency) {
        set(PROPERTY_CAMFREQUENCY, camFrequency);
    }

    public Long getCamFrequencyamt() {
        return (Long) get(PROPERTY_CAMFREQUENCYAMT);
    }

    public void setCamFrequencyamt(Long camFrequencyamt) {
        set(PROPERTY_CAMFREQUENCYAMT, camFrequencyamt);
    }

    public Date getCamNextdue() {
        return (Date) get(PROPERTY_CAMNEXTDUE);
    }

    public void setCamNextdue(Date camNextdue) {
        set(PROPERTY_CAMNEXTDUE, camNextdue);
    }

    public Date getCamStartdate() {
        return (Date) get(PROPERTY_CAMSTARTDATE);
    }

    public void setCamStartdate(Date camStartdate) {
        set(PROPERTY_CAMSTARTDATE, camStartdate);
    }
