...
import org.wirabumi.gen.oez.oez_process_plan_v;
/**
...
public class Operation extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    ...
    public static final String PROPERTY_OEZPROCESSPLANVLIST = "oezProcessPlanVList";
    ...
    public Operation() {
        ...
        setDefaultValue(PROPERTY_OEZPROCESSPLANVLIST, new ArrayList<Object>());
    }
    ...
    @SuppressWarnings("unchecked")
    public List<oez_process_plan_v> getOezProcessPlanVList() {
      return (List<oez_process_plan_v>) get(PROPERTY_OEZPROCESSPLANVLIST);
    }

    public void setOezProcessPlanVList(List<oez_process_plan_v> oezProcessPlanVList) {
        set(PROPERTY_OEZPROCESSPLANVLIST, oezProcessPlanVList);
    }
