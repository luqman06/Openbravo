...
/**
 * Entity class for entity OBEDL_Configuration (stored in table OBEDL_Configuration).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class OBEDLConfiguration extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "OBEDL_Configuration";
    public static final String ENTITY_NAME = "OBEDL_Configuration";
