...
/**
 * Entity class for entity ID_TaxConversionRate (stored in table ID_Tax_Conversion_Rate).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class IDTaxConversionRate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ID_Tax_Conversion_Rate";
    public static final String ENTITY_NAME = "ID_TaxConversionRate";
    ...
    public static final String PROPERTY_KMK = "kMK";
    public static final String PROPERTY_TANGGALKMK = "tanggalKMK";

    public IDTaxConversionRate() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_CONVERSIONRATETYPE, "S");
        setDefaultValue(PROPERTY_MULTIPLERATEBY, new BigDecimal(0));
        setDefaultValue(PROPERTY_DIVIDERATEBY, new BigDecimal(0));
    }
    ...
    public String getKMK() {
        return (String) get(PROPERTY_KMK);
    }

    public void setKMK(String kMK) {
        set(PROPERTY_KMK, kMK);
    }

    public Date getTanggalKMK() {
        return (Date) get(PROPERTY_TANGGALKMK);
    }

    public void setTanggalKMK(Date tanggalKMK) {
        set(PROPERTY_TANGGALKMK, tanggalKMK);
    }
