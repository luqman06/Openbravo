...
/**
 * Entity class for entity pyr_deduction (stored in table pyr_deduction).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class pyr_deduction extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "pyr_deduction";
    public static final String ENTITY_NAME = "pyr_deduction";
    ...
    public static final String PROPERTY_DEDUCTIONGROUP = "deductionGroup";
    public static final String PROPERTY_HRISDEDUCTIONTEMPLATELIST = "hRISDeductionTemplateList";
    ...
    public static final String PROPERTY_HRISRAPPELSALARYRAPPELDEDUCTIONIDLIST = "hrisRappelSalaryRappelDeductionIDList";
    ...
    public pyr_deduction() {
        ...
        setDefaultValue(PROPERTY_HRISDEDUCTIONTEMPLATELIST, new ArrayList<Object>());
        ...
        setDefaultValue(PROPERTY_HRISRAPPELSALARYRAPPELDEDUCTIONIDLIST, new ArrayList<Object>());
    ...
    public DeductionGroup getDeductionGroup() {
        return (DeductionGroup) get(PROPERTY_DEDUCTIONGROUP);
    }

    public void setDeductionGroup(DeductionGroup deductionGroup) {
        set(PROPERTY_DEDUCTIONGROUP, deductionGroup);
    }

    @SuppressWarnings("unchecked")
    public List<HRISDeductionTemplate> getHRISDeductionTemplateList() {
      return (List<HRISDeductionTemplate>) get(PROPERTY_HRISDEDUCTIONTEMPLATELIST);
    }

    public void setHRISDeductionTemplateList(List<HRISDeductionTemplate> hRISDeductionTemplateList) {
        set(PROPERTY_HRISDEDUCTIONTEMPLATELIST, hRISDeductionTemplateList);
    }
    ...
    @SuppressWarnings("unchecked")
    public List<hris_rappel_salary> getHrisRappelSalaryRappelDeductionIDList() {
      return (List<hris_rappel_salary>) get(PROPERTY_HRISRAPPELSALARYRAPPELDEDUCTIONIDLIST);
    }

    public void setHrisRappelSalaryRappelDeductionIDList(List<hris_rappel_salary> hrisRappelSalaryRappelDeductionIDList) {
        set(PROPERTY_HRISRAPPELSALARYRAPPELDEDUCTIONIDLIST, hrisRappelSalaryRappelDeductionIDList);
    }
