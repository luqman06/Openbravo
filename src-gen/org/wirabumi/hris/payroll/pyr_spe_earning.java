...
/**
 * Entity class for entity pyr_spe_earning (stored in table pyr_spe_earning).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class pyr_spe_earning extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "pyr_spe_earning";
    public static final String ENTITY_NAME = "pyr_spe_earning";
