...
/**
 * Entity class for entity Pyr_Bp_Deduction (stored in table Pyr_Bp_Deduction).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class Pyr_Bp_Deduction extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "Pyr_Bp_Deduction";
    public static final String ENTITY_NAME = "Pyr_Bp_Deduction";
