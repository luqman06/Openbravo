...
/**
 * Entity class for entity pyr_incidental_deduction (stored in table pyr_incidental_deduction).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class pyr_incidental_deduction extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "pyr_incidental_deduction";
    public static final String ENTITY_NAME = "pyr_incidental_deduction";
    ...
    public pyr_incidental_deduction() {
