...
/**
 * Entity class for entity lv_c_bp_leave (stored in table lv_c_bp_leave).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class lv_c_bp_leave extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "lv_c_bp_leave";
    public static final String ENTITY_NAME = "lv_c_bp_leave";
    ...
    public static final String PROPERTY_LEAVECATALOGUE = "leaveCatalogue";
    ...
    public lv_set_leave getLeaveCatalogue() {
        return (lv_set_leave) get(PROPERTY_LEAVECATALOGUE);
    }

    public void setLeaveCatalogue(lv_set_leave leaveCatalogue) {
        set(PROPERTY_LEAVECATALOGUE, leaveCatalogue);
    }
