...
/**
 * Entity class for entity lv_mass_leave (stored in table lv_mass_leave).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class lv_mass_leave extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "lv_mass_leave";
    public static final String ENTITY_NAME = "lv_mass_leave";
    ...
    public lv_set_leave getEmployeeLeave() {
        return (lv_set_leave) get(PROPERTY_EMPLOYEELEAVE);
    }

    public void setEmployeeLeave(lv_set_leave employeeLeave) {
    ...
    public Boolean isGenerateEmployee() {
        return (Boolean) get(PROPERTY_GENERATEEMPLOYEE);
    }

    public void setGenerateEmployee(Boolean generateEmployee) {
        set(PROPERTY_GENERATEEMPLOYEE, generateEmployee);
    }
