...
/**
 * Entity class for entity ta_timemaster (stored in table ta_timemaster).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class LabourTimeMaster extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ta_timemaster";
    public static final String ENTITY_NAME = "ta_timemaster";
