...
/**
 * Entity class for entity ta_tukar_shift (stored in table ta_tukar_shift).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ta_tukar_shift extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ta_tukar_shift";
    public static final String ENTITY_NAME = "ta_tukar_shift";
    ...
    public static final String PROPERTY_CHECKIN2 = "checkin2";
    public static final String PROPERTY_CHECKOUT2 = "checkout2";
    ...
    public static final String PROPERTY_SWITCHEDDATE = "switcheddate";

    public ta_tukar_shift() {
    ...
    public Date getCheckin2() {
        return (Date) get(PROPERTY_CHECKIN2);
    }

    public void setCheckin2(Date checkin2) {
        set(PROPERTY_CHECKIN2, checkin2);
    }

    public Date getCheckout2() {
        return (Date) get(PROPERTY_CHECKOUT2);
    }

    public void setCheckout2(Date checkout2) {
        set(PROPERTY_CHECKOUT2, checkout2);
    }
    ...
    public Date getSwitcheddate() {
        return (Date) get(PROPERTY_SWITCHEDDATE);
    }

    public void setSwitcheddate(Date switcheddate) {
        set(PROPERTY_SWITCHEDDATE, switcheddate);
    }
