...
/**
 * Entity class for entity ta_akumulasi_pot_gaji (stored in table ta_akumulasi_pot_gaji).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ta_akumulasi_pot_gaji extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ta_akumulasi_pot_gaji";
    public static final String ENTITY_NAME = "ta_akumulasi_pot_gaji";
    ...
    public static final String PROPERTY_TADETAILPOTGAJILIST = "taDetailPotGajiList";

    public ta_akumulasi_pot_gaji() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_AMOUNT, new BigDecimal(0));
        setDefaultValue(PROPERTY_DOCUMENTSTATUS, "DR");
        setDefaultValue(PROPERTY_DOCUMENTACTION, "CO");
        setDefaultValue(PROPERTY_TADETAILPOTGAJILIST, new ArrayList<Object>());
    }
    ...
    public List<ta_detail_pot_gaji> getTaDetailPotGajiList() {
      return (List<ta_detail_pot_gaji>) get(PROPERTY_TADETAILPOTGAJILIST);
    }

    public void setTaDetailPotGajiList(List<ta_detail_pot_gaji> taDetailPotGajiList) {
        set(PROPERTY_TADETAILPOTGAJILIST, taDetailPotGajiList);
    }
