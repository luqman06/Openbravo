...
/**
 * Entity class for entity ta_c_bp_shift (stored in table ta_c_bp_shift).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ta_c_bp_shift extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ta_c_bp_shift";
    public static final String ENTITY_NAME = "ta_c_bp_shift";
