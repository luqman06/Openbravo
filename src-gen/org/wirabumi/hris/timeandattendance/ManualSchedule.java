...
/**
 * Entity class for entity ta_manualschedule (stored in table ta_manualschedule).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ManualSchedule extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "ta_manualschedule";
    public static final String ENTITY_NAME = "ta_manualschedule";
    ...
    public static final String PROPERTY_MANUALSCHEDULEGROUP = "manualScheduleGroup";
    ...
    public ManualScheduleGroup getManualScheduleGroup() {
        return (ManualScheduleGroup) get(PROPERTY_MANUALSCHEDULEGROUP);
    }

    public void setManualScheduleGroup(ManualScheduleGroup manualScheduleGroup) {
        set(PROPERTY_MANUALSCHEDULEGROUP, manualScheduleGroup);
    }
