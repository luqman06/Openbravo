...
/**
 * Entity class for entity hris_training_plan (stored in table hris_training_plan).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class hris_training_plan extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "hris_training_plan";
    public static final String ENTITY_NAME = "hris_training_plan";
    ...
    public static final String PROPERTY_NOSURATPERINTAH = "nosuratperintah";
    public static final String PROPERTY_HRISTPEMPLOYEELIST = "hrisTpEmployeeList";

    public hris_training_plan() {
    ...
    public String getNosuratperintah() {
        return (String) get(PROPERTY_NOSURATPERINTAH);
    }

    public void setNosuratperintah(String nosuratperintah) {
        set(PROPERTY_NOSURATPERINTAH, nosuratperintah);
    }
