...
/**
 * Entity class for entity hris_competency_jobtitle (stored in table hris_competency_jobtitle).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class hris_competency_jobtitle extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "hris_competency_jobtitle";
    public static final String ENTITY_NAME = "hris_competency_jobtitle";
    ...
    public hris_competency_jobtitle() {
