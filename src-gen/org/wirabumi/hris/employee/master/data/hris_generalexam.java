...
/**
 * Entity class for entity hris_generalexam (stored in table hris_generalexam).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class hris_generalexam extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "hris_generalexam";
    public static final String ENTITY_NAME = "hris_generalexam";
    ...
    public static final String PROPERTY_GENERALASSESMENTTYPE = "generalassesmenttype";
    ...
    public String getGeneralassesmenttype() {
        return (String) get(PROPERTY_GENERALASSESMENTTYPE);
    }

    public void setGeneralassesmenttype(String generalassesmenttype) {
        set(PROPERTY_GENERALASSESMENTTYPE, generalassesmenttype);
    }
