...
/**
 * Entity class for entity hris_employeetransfer (stored in table hris_employeetransfer).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class EmployeeTransfer extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "hris_employeetransfer";
    public static final String ENTITY_NAME = "hris_employeetransfer";
