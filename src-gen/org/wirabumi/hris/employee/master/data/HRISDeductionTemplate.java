...
/**
 * Entity class for entity HRIS_Deduction_Template (stored in table HRIS_Deduction_Template).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class HRISDeductionTemplate extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "HRIS_Deduction_Template";
    public static final String ENTITY_NAME = "HRIS_Deduction_Template";
