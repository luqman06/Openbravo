...
/**
 * Entity class for entity hris_training_competency (stored in table hris_training_competency).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class hris_training_competency extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "hris_training_competency";
    public static final String ENTITY_NAME = "hris_training_competency";
    ...
    public hris_training_competency() {
