...
/**
 * Entity class for entity oez_purchase_tracebility_v (stored in table oez_purchase_tracebility_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class oez_purchase_tracebility_v extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "oez_purchase_tracebility_v";
    public static final String ENTITY_NAME = "oez_purchase_tracebility_v";
    ...
    public oez_purchase_tracebility_v() {
    ...
    public Long getPrepaymentamt() {
        return (Long) get(PROPERTY_PREPAYMENTAMT);
    }

    public void setPrepaymentamt(Long prepaymentamt) {
