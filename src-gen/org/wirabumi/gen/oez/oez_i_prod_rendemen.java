...
/**
 * Entity class for entity oez_i_prod_rendemen (stored in table oez_i_prod_rendemen).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class oez_i_prod_rendemen extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "oez_i_prod_rendemen";
    public static final String ENTITY_NAME = "oez_i_prod_rendemen";
    ...
    public static final String PROPERTY_ORGANIZATIONNAME = "organizationName";
    public static final String PROPERTY_ORGANIZATIONKEY = "organizationKey";
    ...
    public static final String PROPERTY_IMPORTRENDEMEN = "importRendemen";
    public static final String PROPERTY_TONASEHOGREADER = "tonaseHoGreader";

    public oez_i_prod_rendemen() {
        setDefaultValue(PROPERTY_ACTIVE, true);
        setDefaultValue(PROPERTY_ISPROCESSED, false);
        setDefaultValue(PROPERTY_IMPORTRENDEMEN, false);
    }
    ...
    public String getOrganizationName() {
        return (String) get(PROPERTY_ORGANIZATIONNAME);
    }

    public void setOrganizationName(String organizationName) {
        set(PROPERTY_ORGANIZATIONNAME, organizationName);
    }

    public String getOrganizationKey() {
        return (String) get(PROPERTY_ORGANIZATIONKEY);
    }

    public void setOrganizationKey(String organizationKey) {
        set(PROPERTY_ORGANIZATIONKEY, organizationKey);
    }
    ...
    public Boolean isImportRendemen() {
        return (Boolean) get(PROPERTY_IMPORTRENDEMEN);
    }

    public void setImportRendemen(Boolean importRendemen) {
        set(PROPERTY_IMPORTRENDEMEN, importRendemen);
    }
