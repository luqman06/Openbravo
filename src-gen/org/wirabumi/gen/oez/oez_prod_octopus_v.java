...
/**
 * Entity class for entity oez_prod_octopus_v (stored in table oez_prod_octopus_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class oez_prod_octopus_v extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "oez_prod_octopus_v";
    public static final String ENTITY_NAME = "oez_prod_octopus_v";
    ...
    public static final String PROPERTY_RENDCUTTINGRH = "rendcuttingrh";
    public static final String PROPERTY_RENDCUTTINGRL = "rendcuttingrl";
    public static final String PROPERTY_RENDCUTTINGRN = "rendcuttingrn";
    public static final String PROPERTY_RENDSOAKINGHEAD = "rendsoakinghead";
    public static final String PROPERTY_RENDSOAKINGLEG = "rendsoakingleg";
    public static final String PROPERTY_RENDCUTTINGCOOK = "rendcuttingcook";
    public static final String PROPERTY_RENDEMENFG = "rendemenfg";
    public static final String PROPERTY_RENDEMENFGBS = "rendemenfgbs";

    public oez_prod_octopus_v() {
    ...
    public Long getRendcuttingrh() {
        return (Long) get(PROPERTY_RENDCUTTINGRH);
    }

    public void setRendcuttingrh(Long rendcuttingrh) {
        set(PROPERTY_RENDCUTTINGRH, rendcuttingrh);
    }

    public Long getRendcuttingrl() {
        return (Long) get(PROPERTY_RENDCUTTINGRL);
    }

    public void setRendcuttingrl(Long rendcuttingrl) {
        set(PROPERTY_RENDCUTTINGRL, rendcuttingrl);
    }

    public Long getRendcuttingrn() {
        return (Long) get(PROPERTY_RENDCUTTINGRN);
    }

    public void setRendcuttingrn(Long rendcuttingrn) {
        set(PROPERTY_RENDCUTTINGRN, rendcuttingrn);
    }

    public Long getRendsoakinghead() {
        return (Long) get(PROPERTY_RENDSOAKINGHEAD);
    }

    public void setRendsoakinghead(Long rendsoakinghead) {
        set(PROPERTY_RENDSOAKINGHEAD, rendsoakinghead);
    }

    public Long getRendsoakingleg() {
        return (Long) get(PROPERTY_RENDSOAKINGLEG);
    }

    public void setRendsoakingleg(Long rendsoakingleg) {
        set(PROPERTY_RENDSOAKINGLEG, rendsoakingleg);
    }

    public Long getRendcuttingcook() {
        return (Long) get(PROPERTY_RENDCUTTINGCOOK);
    }

    public void setRendcuttingcook(Long rendcuttingcook) {
        set(PROPERTY_RENDCUTTINGCOOK, rendcuttingcook);
    }

    public Long getRendemenfg() {
        return (Long) get(PROPERTY_RENDEMENFG);
    }

    public void setRendemenfg(Long rendemenfg) {
        set(PROPERTY_RENDEMENFG, rendemenfg);
    }

    public Long getRendemenfgbs() {
        return (Long) get(PROPERTY_RENDEMENFGBS);
    }

    public void setRendemenfgbs(Long rendemenfgbs) {
        set(PROPERTY_RENDEMENFGBS, rendemenfgbs);
    }
