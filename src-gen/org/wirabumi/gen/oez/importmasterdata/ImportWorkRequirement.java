...
/**
 * Entity class for entity oez_i_workrequirement (stored in table oez_i_workrequirement).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class ImportWorkRequirement extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "oez_i_workrequirement";
    public static final String ENTITY_NAME = "oez_i_workrequirement";
    ...
    public static final String PROPERTY_PROCESSPLANKEY = "processPlanKey";
    ...
    public String getProcessPlanKey() {
        return (String) get(PROPERTY_PROCESSPLANKEY);
    }

    public void setProcessPlanKey(String processPlanKey) {
        set(PROPERTY_PROCESSPLANKEY, processPlanKey);
    }
