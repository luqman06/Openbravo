...
/**
 * Entity class for entity oez_production_run_v (stored in table oez_production_run_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class oez_production_run_v extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "oez_production_run_v";
    public static final String ENTITY_NAME = "oez_production_run_v";
