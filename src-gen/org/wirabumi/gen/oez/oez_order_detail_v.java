...
/**
 * Entity class for entity oez_order_detail_v (stored in table oez_order_detail_v).
 *
 * NOTE: This class should not be instantiated directly. To instantiate this
 * class the {@link org.openbravo.base.provider.OBProvider} should be used.
 */
public class oez_order_detail_v extends BaseOBObject implements Traceable, ClientEnabled, OrganizationEnabled, ActiveEnabled {
    private static final long serialVersionUID = 1L;
    public static final String TABLE_NAME = "oez_order_detail_v";
    public static final String ENTITY_NAME = "oez_order_detail_v";
    ...
    public static final String PROPERTY_GRFEFERENCE = "grfeference";
    ...
    public String getGrfeference() {
        return (String) get(PROPERTY_GRFEFERENCE);
    }

    public void setGrfeference(String grfeference) {
        set(PROPERTY_GRFEFERENCE, grfeference);
    }
