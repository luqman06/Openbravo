  ...
  public Fact createFact(AcctSchema as, ConnectionProvider conn, Connection con,
    ...
    for (int i = 0; p_lines != null && i < p_lines.length; i++) {
      ...
      if (line.m_Productiontype.equals("+")) {
        log4jDocProduction.debug("DocProduction - createFact - processing Productiontype: "
          + line.m_Productiontype);
      ...
      String accountDescription = factLine.getM_acct().description;
      if (accountDescription==null)
    	  accountDescription = "";
      
      log4jDocProduction
      .debug("DocProduction - createFact - debit amount: " + factLine.getM_AmtAcctDr() + " credit amount: " + factLine.getM_AmtAcctCr() + " account search key: " + accountDescription);
    }
    SeqNo = "0";
    return fact;
  } // createFact
