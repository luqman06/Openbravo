...
public class ReconciliationsD42CAD72E7DA49AFACD14A0B5B119178 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "CF72EE8AC03944F0A0B9C21B096B7412";
  private static final String tabId = "D42CAD72E7DA49AFACD14A0B5B119178";
...
params.put("action", straction);
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          vars.setSessionValue("Posted|tabName", "ReconciliationsD42CAD72E7DA49AFACD14A0B5B119178");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "ReconciliationsD42CAD72E7DA49AFACD14A0B5B119178_Edition.html");
    ...
    xmlDocument.setParameter("action", Utility.getContext(this, vars, "Process_Reconciliation", "CF72EE8AC03944F0A0B9C21B096B7412"));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("buttonFF8080812E2F8EAE012E2F94CF470014.originalParams"), comboTableData, windowId, Utility.getContext(this, vars, "Process_Reconciliation", "CF72EE8AC03944F0A0B9C21B096B7412"));
...
comboTableData = null;
    ...
    xmlDocument.setParameter("action", Utility.getContext(this, vars, "Process_Reconciliation", "CF72EE8AC03944F0A0B9C21B096B7412"));
    comboTableData = new ComboTableData(vars, this, "17", "action", "FF8080812E443491012E443C053A001A", "FF808081332719060133271E5BB1001B", Utility.getContext(this, vars, "#AccessibleOrgTree", ""), Utility.getContext(this, vars, "#User_Client", ""), 0);
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button6BF16EFC772843AC9A17552AE0B26AB7.originalParams"), comboTableData, windowId, Utility.getContext(this, vars, "Process_Reconciliation", "CF72EE8AC03944F0A0B9C21B096B7412"));
    xmlDocument.setData("reportaction", "liststructure", comboTableData.select(false));
comboTableData = null;
    } catch (Exception ex) {
      throw new ServletException(ex);
