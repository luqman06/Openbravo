...
public class Header647342C3516C4C849F867A4A3E6E5F72 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "B954692E69524493825FA41AC4104E7F";
  private static final String tabId = "647342C3516C4C849F867A4A3E6E5F72";
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "30", "M_PriceList_ID", strmPricelistId, vars.getClient(), vars.getOrg(), vars.getUser());
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Header647342C3516C4C849F867A4A3E6E5F72_Edition.html");
    ...
    xmlDocument.setParameter("AD_Org_ID", Utility.getContext(this, vars, "AD_Org_ID", "B954692E69524493825FA41AC4104E7F"));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button1004400000.originalParams"), comboTableData, windowId, Utility.getContext(this, vars, "AD_Org_ID", "B954692E69524493825FA41AC4104E7F"));
...
comboTableData = null;
    xmlDocument.setParameter("C_BPartner_ID", Header647342C3516C4C849F867A4A3E6E5F72Data.selectActP1004400000_C_BPartner_ID(this, Utility.getContext(this, vars, "M_Requisition_ID", "B954692E69524493825FA41AC4104E7F")));
    xmlDocument.setParameter("C_BPartner_IDR", Header647342C3516C4C849F867A4A3E6E5F72Data.selectActDefC_BPartner_ID(this, Header647342C3516C4C849F867A4A3E6E5F72Data.selectActP1004400000_C_BPartner_ID(this, Utility.getContext(this, vars, "M_Requisition_ID", "B954692E69524493825FA41AC4104E7F"))));
    xmlDocument.setParameter("M_PriceList_ID", Header647342C3516C4C849F867A4A3E6E5F72Data.selectActP1004400000_M_PriceList_ID(this, Utility.getContext(this, vars, "M_Requisition_ID", "B954692E69524493825FA41AC4104E7F")));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button1004400000.originalParams"), comboTableData, windowId, Header647342C3516C4C849F867A4A3E6E5F72Data.selectActP1004400000_M_PriceList_ID(this, Utility.getContext(this, vars, "M_Requisition_ID", "B954692E69524493825FA41AC4104E7F")));
