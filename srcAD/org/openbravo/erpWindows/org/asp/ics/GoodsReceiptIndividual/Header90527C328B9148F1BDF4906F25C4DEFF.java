...
public class Header90527C328B9148F1BDF4906F25C4DEFF extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "8D19775BF5FE4E97AC7E24B527ED2547";
  private static final String tabId = "90527C328B9148F1BDF4906F25C4DEFF";
...
params.put("finPaymentmethodId", strfinPaymentmethodId);
        ...
        vars.setSessionValue("CreateFrom|tabName", "Header90527C328B9148F1BDF4906F25C4DEFF");
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          OBError myError = Utility.translateError(this, vars, vars.getLanguage(), Utility.messageBD(this, "NoWriteAccess", vars.getLanguage()));
          vars.setMessage(tabId, myError);
          printPageClosePopUp(response, vars);
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          vars.setSessionValue("Posted|tabName", "Header90527C328B9148F1BDF4906F25C4DEFF");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Header90527C328B9148F1BDF4906F25C4DEFF_Edition.html");
    ...
    xmlDocument.setParameter("M_PriceList_Version_ID", Header90527C328B9148F1BDF4906F25C4DEFFData.selectActP154_M_PriceList_Version_ID(this, "N", Utility.getContext(this, vars, "C_BPARTNER_ID", "8D19775BF5FE4E97AC7E24B527ED2547")));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button154.originalParams"), comboTableData, windowId, Header90527C328B9148F1BDF4906F25C4DEFFData.selectActP154_M_PriceList_Version_ID(this, "N", Utility.getContext(this, vars, "C_BPARTNER_ID", "8D19775BF5FE4E97AC7E24B527ED2547")));
