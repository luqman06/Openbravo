...
package org.openbravo.erpWindows.org.wirabumi.cam.AssetPartConsumption;
...
public class Header2B23BADDD9DD4E3AA0BB7868F3D708A7 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "1D35596A27C84AA9A170AA5FA43EA3D4";
  private static final String tabId = "2B23BADDD9DD4E3AA0BB7868F3D708A7";
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "action", straction, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          vars.setSessionValue("Posted|tabName", "Header2B23BADDD9DD4E3AA0BB7868F3D708A7");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Header2B23BADDD9DD4E3AA0BB7868F3D708A7_Edition.html");
