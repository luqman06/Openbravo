...
public class Header0590CB620EFA4E05A5C5AA6EF8E77B78 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "713939521AC64F869553528C0B0242C1";
  private static final String tabId = "0590CB620EFA4E05A5C5AA6EF8E77B78";
...
params.put("finPaymentmethodId", strfinPaymentmethodId);
        ...
        vars.setSessionValue("CreateFrom|tabName", "Header0590CB620EFA4E05A5C5AA6EF8E77B78");
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          OBError myError = Utility.translateError(this, vars, vars.getLanguage(), Utility.messageBD(this, "NoWriteAccess", vars.getLanguage()));
          vars.setMessage(tabId, myError);
          printPageClosePopUp(response, vars);
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          vars.setSessionValue("Posted|tabName", "Header0590CB620EFA4E05A5C5AA6EF8E77B78");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    throws IOException, ServletException {
      ...
      xmlDocument.setParameter("form", "Header0590CB620EFA4E05A5C5AA6EF8E77B78_Edition.html");
    ...
    xmlDocument.setParameter("M_PriceList_Version_ID", Header0590CB620EFA4E05A5C5AA6EF8E77B78Data.selectActP154_M_PriceList_Version_ID(this, "Y", Utility.getContext(this, vars, "C_BPARTNER_ID", "713939521AC64F869553528C0B0242C1")));
    ...
    Utility.fillSQLParameters(this, vars, (FieldProvider) vars.getSessionObject("button154.originalParams"), comboTableData, windowId, Header0590CB620EFA4E05A5C5AA6EF8E77B78Data.selectActP154_M_PriceList_Version_ID(this, "Y", Utility.getContext(this, vars, "C_BPARTNER_ID", "713939521AC64F869553528C0B0242C1")));
