...
public class Header93B877C434EA425DB6BCE84DB72B2B90 extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "8AEBB6A75B774E519060C1D811CA5466";
  private static final String tabId = "93B877C434EA425DB6BCE84DB72B2B90";
  private static final int accesslevel = 1;
  private static final String moduleId = "445952DE4B7840CEBE89E713854839D3";
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("142")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("142");
        SessionInfo.setModuleId("0");
        if (securedProcess || explicitAccess.contains("142")) {
          classInfo.type = "P";
          classInfo.id = "142";
        }
      }
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
     ...
     } else if (vars.commandIn("BUTTONGenerateTo142")) {
        vars.setSessionValue("button142.strgenerateto", vars.getStringParameter("inpgenerateto"));
        vars.setSessionValue("button142.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button142.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button142.strClient", vars.getStringParameter("inpadClientId"));
        ...
        vars.setSessionObject("button142.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "142", request.getServletPath());    
     } else if (vars.commandIn("BUTTON142")) {
        String strC_Invoice_ID = vars.getGlobalVariable("inpcInvoiceId", windowId + "|C_Invoice_ID", "");
        String strgenerateto = vars.getSessionValue("button142.strgenerateto");
        String strProcessing = vars.getSessionValue("button142.strProcessing");
        String strOrg = vars.getSessionValue("button142.strOrg");
        String strClient = vars.getSessionValue("button142.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonGenerateTo142(response, vars, strC_Invoice_ID, strgenerateto, strProcessing);
        }
...
p.put("AD_Org_ID", vars.getStringParameter("inpadOrgId"));
    ...
    } else if (vars.commandIn("SAVE_BUTTONGenerateTo142")) {
        ...
        try {
          ...
          PInstanceProcessData.insertPInstance(this, pinstance, "142", (("C_Invoice_ID".equalsIgnoreCase("AD_Language"))?"0":strC_Invoice_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
          String strmLocatorId = vars.getStringParameter("inpmLocatorId");
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "M_Locator_ID", strmLocatorId, vars.getClient(), vars.getOrg(), vars.getUser());
...
params.put("finPaymentmethodId", strfinPaymentmethodId);
        ...
        vars.setSessionValue("CreateFrom|tabName", "Header93B877C434EA425DB6BCE84DB72B2B90");
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          OBError myError = Utility.translateError(this, vars, vars.getLanguage(), Utility.messageBD(this, "NoWriteAccess", vars.getLanguage()));
          vars.setMessage(tabId, myError);
          printPageClosePopUp(response, vars);
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          vars.setSessionValue("Posted|tabName", "Header93B877C434EA425DB6BCE84DB72B2B90");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonGenerateTo142(HttpServletResponse response, VariablesSecureApp vars, String strC_Invoice_ID, String strgenerateto, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 142");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/GenerateTo142", discard).createXmlDocument();
      xmlDocument.setParameter("key", strC_Invoice_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header93B877C434EA425DB6BCE84DB72B2B90_Edition.html");
      xmlDocument.setParameter("window", windowId);
      xmlDocument.setParameter("css", vars.getTheme());
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "142");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("142");
        vars.removeMessage("142");
        if (myMessage!=null) {
    ...
    xmlDocument.setParameter("M_Locator_IDR", Header93B877C434EA425DB6BCE84DB72B2B90Data.selectActDefM_Locator_ID(this, ""));
    } catch (Exception ex) {
