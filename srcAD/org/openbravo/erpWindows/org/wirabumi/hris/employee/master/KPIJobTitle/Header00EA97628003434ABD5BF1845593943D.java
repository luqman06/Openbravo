...
public class Header00EA97628003434ABD5BF1845593943D extends HttpSecureAppServlet {
  private static final long serialVersionUID = 1L;
  
  private static final String windowId = "7531D0DBE5F84F0BB6DACC328E9B9C39";
  private static final String tabId = "00EA97628003434ABD5BF1845593943D";
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
    ...
    } else if (vars.commandIn("BUTTONGenerate_Kpi_Measurement4CD83C2A2470454DA1762133E0744572")) {
        vars.setSessionValue("button4CD83C2A2470454DA1762133E0744572.strgenerateKpiMeasurement", vars.getStringParameter("inpgenerateKpiMeasurement"));
        ...
        String strHris_Jt_Kpi_Version_ID = vars.getGlobalVariable("inphrisJtKpiVersionId", windowId + "|Hris_Jt_Kpi_Version_ID", "");
        String strgenerateKpiMeasurement = vars.getSessionValue("button4CD83C2A2470454DA1762133E0744572.strgenerateKpiMeasurement");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonGenerate_Kpi_Measurement4CD83C2A2470454DA1762133E0744572(response, vars, strHris_Jt_Kpi_Version_ID, strgenerateKpiMeasurement, strProcessing);
        }


    } else if (vars.commandIn("SAVE_BUTTONGenerate_Kpi_Measurement4CD83C2A2470454DA1762133E0744572")) {
        String strHris_Jt_Kpi_Version_ID = vars.getGlobalVariable("inpKey", windowId + "|Hris_Jt_Kpi_Version_ID", "");
        
        ProcessBundle pb = new ProcessBundle("4CD83C2A2470454DA1762133E0744572", vars).init(this);
        HashMap<String, Object> params= new HashMap<String, Object>();
       
        params.put("Hris_Jt_Kpi_Version_ID", strHris_Jt_Kpi_Version_ID);
...
params.put("cPeriodId", strcPeriodId);
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    void printPageButtonGenerate_Kpi_Measurement4CD83C2A2470454DA1762133E0744572(HttpServletResponse response, VariablesSecureApp vars, String strHris_Jt_Kpi_Version_ID, String strgenerateKpiMeasurement, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 4CD83C2A2470454DA1762133E0744572");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/Generate_Kpi_Measurement4CD83C2A2470454DA1762133E0744572", discard).createXmlDocument();
      xmlDocument.setParameter("key", strHris_Jt_Kpi_Version_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Header00EA97628003434ABD5BF1845593943D_Edition.html");
