...
public class Organization extends HttpSecureAppServlet {
  ...
  public void service(HttpServletRequest request, HttpServletResponse response) throws IOException,
    ...
    if (command.contains("BUTTON")) {
     ...
     SessionInfo.setQueryProfile("manualProcess");
      ...
      if (command.contains("2F841CB320134E4CB64BD6E5AAE09946")) {
        SessionInfo.setProcessType("P");
        SessionInfo.setProcessId("2F841CB320134E4CB64BD6E5AAE09946");
        SessionInfo.setModuleId("27445C8270364452BEB29669FBB21CED");
        if (securedProcess || explicitAccess.contains("2F841CB320134E4CB64BD6E5AAE09946")) {
          classInfo.type = "P";
          classInfo.id = "2F841CB320134E4CB64BD6E5AAE09946";
        }
      }
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
     ...
     } else if (vars.commandIn("BUTTONEM_Oez_Runconfigwizard2F841CB320134E4CB64BD6E5AAE09946")) {
        vars.setSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.stremOezRunconfigwizard", vars.getStringParameter("inpemOezRunconfigwizard"));
        vars.setSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.strProcessing", vars.getStringParameter("inpprocessing", "Y"));
        vars.setSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.strOrg", vars.getStringParameter("inpadOrgId"));
        vars.setSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.strClient", vars.getStringParameter("inpadClientId"));
        ...
        //Save in session needed params for combos if needed
        vars.setSessionObject("button2F841CB320134E4CB64BD6E5AAE09946.originalParams", FieldProviderFactory.getFieldProvider(p));
        printPageButtonFS(response, vars, "2F841CB320134E4CB64BD6E5AAE09946", request.getServletPath());    
     } else if (vars.commandIn("BUTTON2F841CB320134E4CB64BD6E5AAE09946")) {
        String strAD_Org_ID = vars.getGlobalVariable("inpadOrgId", windowId + "|AD_Org_ID", "");
        String stremOezRunconfigwizard = vars.getSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.stremOezRunconfigwizard");
        String strProcessing = vars.getSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.strProcessing");
        String strOrg = vars.getSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.strOrg");
        String strClient = vars.getSessionValue("button2F841CB320134E4CB64BD6E5AAE09946.strClient");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonEM_Oez_Runconfigwizard2F841CB320134E4CB64BD6E5AAE09946(response, vars, strAD_Org_ID, stremOezRunconfigwizard, strProcessing);
        }
...
PInstanceProcessData.insertPInstanceParam(this, pinstance, "10", "Cascade", strcascade, vars.getClient(), vars.getOrg(), vars.getUser());
        ...
        printPageClosePopUp(response, vars);
    } else if (vars.commandIn("SAVE_BUTTONEM_Oez_Runconfigwizard2F841CB320134E4CB64BD6E5AAE09946")) {
        String strAD_Org_ID = vars.getGlobalVariable("inpKey", windowId + "|AD_Org_ID", "");
        String stremOezRunconfigwizard = vars.getStringParameter("inpemOezRunconfigwizard");
        String strProcessing = vars.getStringParameter("inpprocessing");
        OBError myMessage = null;
        try {
          String pinstance = SequenceIdData.getUUID();
          PInstanceProcessData.insertPInstance(this, pinstance, "2F841CB320134E4CB64BD6E5AAE09946", (("AD_Org_ID".equalsIgnoreCase("AD_Language"))?"0":strAD_Org_ID), strProcessing, vars.getUser(), vars.getClient(), vars.getOrg());
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonEM_Oez_Runconfigwizard2F841CB320134E4CB64BD6E5AAE09946(HttpServletResponse response, VariablesSecureApp vars, String strAD_Org_ID, String stremOezRunconfigwizard, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 2F841CB320134E4CB64BD6E5AAE09946");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/EM_Oez_Runconfigwizard2F841CB320134E4CB64BD6E5AAE09946", discard).createXmlDocument();
      xmlDocument.setParameter("key", strAD_Org_ID);
      xmlDocument.setParameter("processing", strProcessing);
      xmlDocument.setParameter("form", "Organization_Edition.html");
      xmlDocument.setParameter("window", windowId);
      ...
      xmlDocument.setParameter("language", "defaultLang=\"" + vars.getLanguage() + "\";");
      xmlDocument.setParameter("directory", "var baseDirectory = \"" + strReplaceWith + "/\";\n");
      xmlDocument.setParameter("processId", "2F841CB320134E4CB64BD6E5AAE09946");
      xmlDocument.setParameter("cancel", Utility.messageBD(this, "Cancel", vars.getLanguage()));
      xmlDocument.setParameter("ok", Utility.messageBD(this, "OK", vars.getLanguage()));
      
      {
        OBError myMessage = vars.getMessage("2F841CB320134E4CB64BD6E5AAE09946");
        vars.removeMessage("2F841CB320134E4CB64BD6E5AAE09946");
        if (myMessage!=null) {
          xmlDocument.setParameter("messageType", myMessage.getType());
          xmlDocument.setParameter("messageTitle", myMessage.getTitle());
          xmlDocument.setParameter("messageMessage", myMessage.getMessage());
