...
public class Header extends HttpSecureAppServlet {
  ...
  public void doPost (HttpServletRequest request, HttpServletResponse response) throws IOException,ServletException {
    ...
    if (vars.commandIn("DEFAULT", "DIRECT", "TAB", "SEARCH", "RELATION", "NEW", "EDIT", "NEXT",
      ...
      throw new OBException("2.50 style command is no longer supported: " + vars.getCommand());
     ...
     } else if (vars.commandIn("BUTTONem_cam_processing800134")) {
        vars.setSessionValue("button800134.stremCamProcessing", vars.getStringParameter("inpemCamProcessing"));
        ...
        String stremCamProcessing = vars.getSessionValue("button800134.stremCamProcessing");
        ...
        if ((org.openbravo.erpCommon.utility.WindowAccessData.hasReadOnlyAccess(this, vars.getRole(), tabId)) || !(Utility.isElementInList(Utility.getContext(this, vars, "#User_Client", windowId, accesslevel),strClient)  && Utility.isElementInList(Utility.getContext(this, vars, "#User_Org", windowId, accesslevel),strOrg))){
          ...
          printPageButtonem_cam_processing800134(response, vars, strA_Amortization_ID, stremCamProcessing, strProcessing);
        }


    } else if (vars.commandIn("SAVE_BUTTONem_cam_processing800134")) {
        String strA_Amortization_ID = vars.getGlobalVariable("inpKey", windowId + "|A_Amortization_ID", "");
        String stremCamProcessing = vars.getStringParameter("inpemCamProcessing");
  ...
  private void printPageButtonFS(HttpServletResponse response, VariablesSecureApp vars, String strProcessId, String path) throws IOException, ServletException {
    ...
    private void printPageButtonem_cam_processing800134(HttpServletResponse response, VariablesSecureApp vars, String strA_Amortization_ID, String stremCamProcessing, String strProcessing)
    throws IOException, ServletException {
      log4j.debug("Output: Button process 800134");
      String[] discard = {"newDiscard"};
      response.setContentType("text/html; charset=UTF-8");
      PrintWriter out = response.getWriter();
      XmlDocument xmlDocument = xmlEngine.readXmlTemplate("org/openbravo/erpCommon/ad_actionButton/em_cam_processing800134", discard).createXmlDocument();
